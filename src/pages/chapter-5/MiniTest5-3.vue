...
const questions = ref([
    {
        id: 'q1',
        question: 'Farmers who want to grow more crops with the same desirable traits prefer asexual reproduction. What is the main advantage of this?',
        options: [
            { id: 'a', text: 'Asexual reproduction produces offspring with the exact same traits as the parent, making it easy to maintain quality crops' },
            { id: 'b', text: 'Asexual reproduction creates more genetic variation, making crops stronger' },
            { id: 'c', text: 'Asexual reproduction requires two parents, which doubles the speed of production' },
            { id: 'd', text: 'Asexual reproduction always produces seedless fruits, which are cheaper to grow' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q2',
        question: 'A single disease wiped out an entire farm of genetically identical banana plants. Which disadvantage of asexual reproduction does this best show?',
        options: [
            { id: 'a', text: 'Asexual reproduction is too slow to keep up with disease spread' },
            { id: 'b', text: 'Without genetic variation, all identical offspring are equally vulnerable to the same disease' },
            { id: 'c', text: 'Asexual reproduction requires too many resources, weakening the plants' },
            { id: 'd', text: 'Asexual reproduction produces offspring that are too small to survive diseases' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q3',
        question: 'Sexual reproduction produces offspring with genetic variation. Why is this considered an advantage over asexual reproduction?',
        options: [
            { id: 'a', text: 'Genetic variation means offspring can better adapt to changes in the environment and survive diseases' },
            { id: 'b', text: 'Genetic variation makes all offspring look the same, which is easier to manage' },
            { id: 'c', text: 'Genetic variation speeds up the process of reproduction significantly' },
            { id: 'd', text: 'Genetic variation ensures that all offspring are stronger than their parents' }
        ],
        correctAnswer: 'a'
    },
    {
        ...
        options: [
            { id: 'a', text: 'The offspring always look exactly like one of the parents' },
            { id: 'b', text: 'Hereditary diseases like hemophilia or color blindness can be passed down to offspring' },
            { id: 'c', text: 'Sexual reproduction cannot produce enough offspring to sustain a population' },
            { id: 'd', text: 'Sexual reproduction only works for plants, not animals' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q5',
        question: 'Why is sexual reproduction considered the basis of heredity?',
        options: [
            { id: 'a', text: 'Because sexual reproduction copies only the mother\'s traits into the offspring' },
            { id: 'b', text: 'Because during fertilization, the sperm and egg combine their chromosomes so the offspring inherits traits from both parents' },
            { id: 'c', text: 'Because sexual reproduction always produces offspring that are identical to the parents' },
            { id: 'd', text: 'Because the traits of the offspring are randomly created during fertilization with no connection to the parents' }
        ],
        correctAnswer: 'b'
    }
])
