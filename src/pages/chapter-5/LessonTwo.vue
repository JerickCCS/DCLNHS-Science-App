  ...
  <q-layout view="hHh lpR fFf">
    <q-header class="bg-white text-black">
      <div class="lesson-toolbar">
        ...
        <div class="lesson-toolbar-title">Lesson 2: Perpetuation of Organisms</div>
...
export default {
  ...
  setup() {
    ...
    // --- Lesson pages ---
    const pages = ref([
      // ── Page 1 ── Perpetuation of Organisms (intro) ──────────────────────────
      `
  <div>
    <div class="header">
  ...
  `,
      ...
      // ── Page 2 ── Sexual intro + Asexual intro ───────────────────────────────
      `
  <div>
    ...
    <p>Asexual reproduction is the type of reproduction that involves only one parent. The offspring will be exactly the same as the parent since only a single parent contributes to the traits the offspring will inherit. There is no genetic variation in asexual reproduction. Offsprings are clones of their parent.</p>
  </div>
  `,

      // ── Page 3 ── Binary Fission (text) + Multiple Fission (text) ────────────
      `
  <div>
    <div class="header">
      <div class="title">Asexual Reproduction in Simple Life-Forms</div>
    </div>
    <p style="font-weight: bold;">Binary Fission</p>
    <p>Binary fission is almost similar to mitosis, but occurs in a simpler way and at a faster rate in bacteria because they do not have a nucleus, numerous organelles, and a long and complicated genetic material. A bacterium replicates its circular DNA followed by cytokinesis to produce two similar daughter bacterial cells. Binary fission also happens in unicellular protists in three directions: longitudinal (Euglena), transverse (Paramecium), and irregular (Amoeba) as shown in figure 5-17.</p>
  ...
  `,
      ...
      // ── Page 4 ── Figure 5-17 + Budding (text + figure) ──────────────────────
      `
  <div>
    <div class="illustration">
      <img src="assets/img/chapter 5/figure 5-17.png" alt="Figure 5-17">
    ...
    <div class="illustration">
      <img src="assets/img/chapter 5/figure 5-18.png" alt="Figure 5-18">
      <div class="caption">Figure 5-18. Yeasts can reproduce through budding.</div>
    </div>
  </div>
  `,

      // ── Page 5 ── Sporulation + Asexual Repro in Animals (header + intro) ────
      `
  <div>
    ...
    <p>In animals, the common types of asexual reproduction are regeneration, fragmentation, and budding. Through regeneration, an organism can regrow a part that has been injured or has fallen off. A new organism of the same kind may also grow from the detached body part. Some echinoderms, such as the sea star, reproduce through regeneration.</p>
  </div>
  `,

      // ── Page 6 ── Fragmentation in animals + Figures 5-19 & 5-20 ─────────────
      `
  <div>
    <p>Fragmentation occurs when the body of the parent breaks into distinct pieces, each of which can become an offspring. Planaria reproduces in this manner (figure 5-19).</p>
    <div class="illustration">
      <img src="assets/img/chapter 5/figure 5-19.png" alt="Figure 5-19">
      <div class="caption">Figure 5-19. Planaria reproduces through fragmentation.</div>
    </div>
    <div class="illustration">
      <img src="assets/img/chapter 5/figure 5-20.png" alt="Figure 5-20">
      <div class="caption">Figure 5-20. Sea stars reproduce through regeneration.</div>
    </div>
  </div>
  `,

      // ── Page 7 ── Animal Budding (text) + Figures 5-21 & 5-22 ─────────────────
      `
  <div>
    ...
    <div class="illustration">
      <img src="assets/img/chapter 5/figure 5-21.png" alt="Figure 5-21">
      <div class="caption">Figure 5-21. Hydra reproduces through budding.</div>
    </div>
    <div class="illustration">
      <img src="assets/img/chapter 5/figure 5-22.png" alt="Figure 5-22">
      <div class="caption">Figure 5-22. Sponges form gemmules through internal budding.</div>
    </div>
  </div>
  `,

      // ── Page 8 ── Asexual Repro in Plants (intro + stolons) ──────────────────
      `
  <div>
    <div class="header">
    ...
    <div class="illustration">
      <img src="assets/img/chapter 5/figure 5-23.png" alt="Figure 5-23">
      <div class="caption">Figure 5-23. Strawberry is a stoloniferous plant.</div>
    </div>
  </div>
  `,

      // ── Page 9 ── Rhizomes + Tubers ──────────────────────────────────────────
      `
  <div>
    ...
    <div class="illustration">
      <img src="assets/img/chapter 5/figure 5-24.png" alt="Figure 5-24">
      <div class="caption">Figure 5-24. Ginger is a rhizome.</div>
    </div>
    <p>Tubers, such as potatoes (figure 5-25), are underground storage stems from which new plants can grow.</p>
    <div class="illustration">
      <img src="assets/img/chapter 5/figure 5-25.png" alt="Figure 5-25">
      <div class="caption">Figure 5-25. Potato is a tuber.</div>
    </div>
  </div>
  `,

      // ── Page 10 ── Bulbs + Bulblets ──────────────────────────────────────────
      `
  <div>
    ...
    <div class="illustration">
      <img src="assets/img/chapter 5/figure 5-26.png" alt="Figure 5-26">
      <div class="caption">Figure 5-26. Onions are bulbs.</div>
    </div>
    ...
    <div class="illustration">
      <img src="assets/img/chapter 5/figure 5-27.png" alt="Figure 5-27">
      <div class="caption">Figure 5-27. Garlic is a bulblet.</div>
    </div>
  </div>
  `,

      // ── Page 11 ── Taro (fig 5-28) + Fragmentation in plants ─────────────────
      `
  <div>
    <div class="illustration">
      <img src="assets/img/chapter 5/figure 5-28.png" alt="Figure 5-28">
      <div class="caption">Figure 5-28. Taro.</div>
    </div>
    <p>Parts of a plant may also form buds and grow into a new plant in a process called fragmentation. Fragmentation may also occur when a plant part that is not specialized for reproduction breaks off from the parent plant and grows into a new plant. Opuntia microdasys, or bunny ear cactus, has brittle stems and leaves that often break off when animals brush against them. Any part of the broken-off stems or leaves touching the ground will form roots and grow into a new plant under appropriate conditions.</p>
  </div>
  `,

      // ── Page 12 ── Plantlets + Artificial Vegetative Reproduction ───────────
      `
  <div>
    <p>Plantlets are miniature versions of a parent plant. These tissues may even develop roots while still attached to the parent plant. The leaves of Bryophyllum pinnatum (katakataka plant) and Kalanchoe daigremontiana (mother of thousands) reproduce through plantlets.</p>
  ...
  `,
      ...
      // ── Page 13 ── Science Pioneer ───────────────────────────────────────────
      `
  <div>
    <div class="header">
      <div class="title">SCIENCE PIONEER</div>
    </div>
    <p>Luther Burbank (1849–1926) is considered a pioneer in agricultural science. In the 1870s, he developed more than 800 new strains of fruits, vegetables, flowers, and grasses. Many of his hybrids were important to the revolution in agriculture and food production in the 20th century. One of his earliest achievements was the Russet Burbank potato—a blight-resistant variant developed to prevent the decimation of potato crops like what happened in Ireland in the late 1840s and early 1850s.</p>
  </div>
  `,

      // ── Page 13 ── Mini Lab 5-1 ───────────────────────────────────────────────
      `
  <div>
    <div class="info-card">
  ...
  `,
      ...
      // ── Page 14 ── Sexual Reproduction (intro) ───────────────────────────────
      `
  <div>
    <div class="header">
      <div class="title">Sexual Reproduction</div>
    </div>
    <p>As mentioned earlier, sexual reproduction involves two parents that contribute genetic material to the offspring. One parent contributes the egg and the other parent the sperm. The sperm and the egg are produced through a meiotic cycle called spermatogenesis and oogenesis, respectively. Spermatogenesis happens in the male reproductive system, which produces four sperm cells from one parent spermatogonia. Oogenesis happens in the female reproductive system, which produces only one egg cell from one parent oogonia.</p>
    <p>Fertilization occurs when the egg cell is united with a sperm cell to form a zygote. Offsprings produced through sexual reproduction vary genetically.</p>
  </div>
  `,

      // ── Page 15 ── Sexual Reproduction in Animals + Plants (intro) ────────────
      `
  <div>
    <div class="header">
    ...
    <p>Plants may also reproduce sexually through their reproductive parts. These parts produce sex cells or gametes in the form of ovules and pollen grains. Petals attract insects and other pollinators through their colors and nectaries—glands that secrete nectar, a sweet liquid that serves as food to some insects. The insects and other pollinators that are attracted to the flowers then pollinate them.</p>
  </div>
  `,

      // ── Page 16 ── Flower parts: Stamen + Figure 5-29 ─────────────────────────
      `
  <div>
    <p>Flowers are the reproductive organs that produce the egg and sperm cells in plants. The male reproductive organ is called the stamen, which is made up of two parts: the anther and filament. The anther produces pollen grains, which contain the sperm cell. The filament supports or holds the anther.</p>
    <div class="illustration">
      <img src="assets/img/chapter 5/figure 5-29.png" alt="Figure 5-29">
      <div class="caption">Figure 5-29. A perfect flower has both male and female reproductive parts.</div>
    </div>
    <p>The female reproductive organ is the pistil, composed of the stigma, style, and ovary. The stigma is where the pollen grains land in a process called pollination. The style is where the sperm nuclei travel to reach the ovary, which houses the ovule containing the egg cells.</p>
  </div>
  `,

      // ── Page 17 ── Perfect vs Imperfect Flowers + Types of Fertilization ──────
      `
  <div>
    <p>When the sperm that passes through the style reaches the egg in the ovule, the two reproductive cells fuse in a process called fertilization. Flowers with both male and female reproductive organs are called perfect or bisexual flowers. Flowers that have only one of the reproductive organs are called imperfect or unisexual flowers, such as squash and corn.</p>
    <div class="header">
      <div class="title">Types of Fertilization</div>
    </div>
    <p>There are two mechanisms by which fertilization takes place: external and internal. External fertilization occurs when the eggs are fertilized outside the body—common among aquatic organisms such as frogs. Internal fertilization occurs when the eggs are fertilized in the female reproductive tract. In most terrestrial organisms, including humans, internal fertilization is an adaptation to prevent the fertilized egg from dehydration.</p>
  </div>
  `,

      // ── Page 18 ── Fertilization and Transfer of Traits ──────────────────────
      `
  <div>
    <div class="header">
      <div class="title">Fertilization and the Transfer of Traits</div>
    </div>
    <p>At the time of fertilization, a sperm cell penetrates an egg cell. Both the sex cells or gametes (sperm and egg) are haploid cells—cells that contain a single set of chromosomes. The sperm carries a copy of all the traits of the male parent. This will combine with the traits of the female parent carried by the egg cell.</p>
    <p>The union of the egg cell and sperm cell called fertilization brings the diploid or completes the number of chromosomes of the cell, creating a zygote. Therefore, the traits of the zygote are a combination of the male and female parents' traits carried and passed on through the chromosomes.</p>
  </div>
  `,

      // ── Page 19 ── Mini Test 5-2 ─────────────────────────────────────────────
      `
  <div>
    <div class="info-card">
  ...
  `,
      ...
      // ── Page 20 ── Advantages of Asexual Reproduction ────────────────────────
      `
  <div>
    <div class="header">
    ...
    <p>Through asexual reproduction, offsprings can be produced from seedless varieties of plants. In general, seedless fruits and vegetables have longer shelf lives and are of better quality than their counterparts with seeds, making them highly desirable for growers and consumers alike.</p>
  </div>
  `,

      // ── Page 21 ── Disadvantages of Asexual + Advantages of Sexual ────────────
      `
  <div>
    <p>However, having no genetic variation can make species vulnerable to sudden changes in environmental conditions. A single disease can wipe out entire populations of genetically identical species, which can lead to economic losses in the case of agriculturally important crops.</p>
  ...
  `,
      ...
      // ── Page 22 ── Disadvantages of Sexual Reproduction ──────────────────────
      `
  <div>
    <p>However, sexual reproduction may also be disadvantageous in some ways. Finding a mate and producing gametes are factors that slow down the success of sexual reproduction. In fertilization, there is also no guarantee that the sex cells will successfully fuse and form a zygote. If a zygote does form, it will take time to grow and develop.</p>
    <p>Hereditary diseases and disorders, such as Klinefelter syndrome, hemophilia, color blindness, and sickle cell anemia, can also be passed down to the offsprings.</p>
  </div>
  `,

      // ── Page 23 ── Mini Test 5-3 ─────────────────────────────────────────────
      `
  <div>
    <div class="info-card">
