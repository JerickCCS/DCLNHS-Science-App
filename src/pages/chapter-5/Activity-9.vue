    ...
    <q-layout view="hHh lpR fFf">
        <q-header class="bg-white text-black">
            <q-toolbar>
                ...
                <q-toolbar-title class="navbar-title">Activity 9: Sexual Reproduction in Plants</q-toolbar-title>
