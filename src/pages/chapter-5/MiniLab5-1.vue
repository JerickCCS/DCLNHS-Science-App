...
const questions = ref([
    {
        id: 'q1',
        question: 'You planted a potato, garlic, ginger, and a peperomia leaf in soil. What type of plant parts are a potato, garlic, and ginger?',
        options: [
            { id: 'a', text: 'A potato is a tuber, garlic is a bulb, and ginger is a rhizome — all modified stems that store nutrients' },
            { id: 'b', text: 'They are all types of roots that absorb water from the soil' },
            { id: 'c', text: 'They are all seeds that need to be peeled before planting' },
            { id: 'd', text: 'They are all flowers used for reproduction' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q2',
        question: 'After one week of watering the planted materials, what would you most likely observe?',
        options: [
            { id: 'a', text: 'The materials would rot completely and disappear into the soil' },
            { id: 'b', text: 'Nothing would change because they need seeds to grow' },
            { id: 'c', text: 'The materials would begin to sprout and grow new plants' },
            { id: 'd', text: 'The materials would turn into flowers immediately' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q3',
        question: 'The peperomia leaf was planted without roots or seeds. Where does the new plant come from?',
        options: [
            { id: 'a', text: 'The new plant comes from tiny seeds hidden inside the leaf' },
            { id: 'b', text: 'The leaf itself contains cells that can grow into a brand new plant' },
            { id: 'c', text: 'The soil provides everything needed to create a new plant on its own' },
            { id: 'd', text: 'The leaf needs to stay attached to the parent plant to grow' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q4',
        question: 'None of the planted materials used seeds to produce a new plant. What type of reproduction does this activity show?',
        options: [
            { id: 'a', text: 'Sexual reproduction, because two parents are involved' },
            { id: 'b', text: 'Fertilization, because the soil acts as the second parent' },
            { id: 'c', text: 'Asexual reproduction, because a new plant grows from just one parent without seeds' },
            { id: 'd', text: 'Pollination, because insects helped the plants grow' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q5',
        question: 'The new plants that grew from the potato, garlic, ginger, and peperomia leaf will look exactly like their parent plants. Why does this happen?',
        options: [
            { id: 'a', text: 'Because the soil passes on the traits of the parent plant to the new plant' },
            { id: 'b', text: 'Because asexual reproduction produces offspring with the exact same genes as the single parent' },
            { id: 'c', text: 'Because new plants always randomly look like their parent' },
            { id: 'd', text: 'Because water changes the genes of the plant to match the parent' }
        ],
        correctAnswer: 'b'
    }
])
