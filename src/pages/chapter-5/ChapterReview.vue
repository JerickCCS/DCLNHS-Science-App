...
export default {
    ...
    setup() {
        ...
        const lessonId = lesson ? String(lesson.id) : "39"
    ...
    <div>
      ...
      <p>• There are two types of cell division: mitosis and meiosis.</p>
      <p>• Mitosis happens in all cells and produces daughter cells identical to each other and to the parent cell.</p>
      <p>• Meiosis happens in the production of sex cells and produces daughter cells that contain half the number of chromosomes of the parent cell.</p>
    </div>
    `,
            `
    <div>
      ...
      <p>• There is only one parent involved in asexual reproduction, and the offspring is identical to the parent.</p>
      <p>• Sexual reproduction involves two parents and produces offsprings that are not identical to the parents.</p>
      <p>• The union of the egg cell and the sperm cell is called fertilization.</p>
    </div>
    `
        ])
