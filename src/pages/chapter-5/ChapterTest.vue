...
export default {
    data() {
        const quizQuestions = [
            {
                question: "When does DNA replication occur in the cell cycle?",
                options: [
                    "G1 phase",
                    "G2 phase",
                    "M phase",
            ...
            {
                question: "Why do cells undergo cell division?",
                options: [
                    "To produce more cells",
                    "To replace worn-out and dead cells",
            ...
            {
                question: "Which process refers to the union of the egg cell and the sperm cell?",
                options: [
                    "Fertilization",
                    "Fragmentation",
                    "Oogenesis",
            ...
            {
                question: "Which of the following types of reproduction will have no or limited difference from the traits of the parent organism?",
                options: [
                    "Sexual reproduction",
            ...
            },
            {
                ...
                options: [
                    "Two halves of a replicative chromosome",
                    "Two chromosomes with the same alleles",
                    "Two identical chromosomes from a single parent",
                    "Two chromosomes with similar length, centromere location, and gene position"
                ],
                correctAnswer: "Two chromosomes with similar length, centromere location, and gene position",
                image: null
            },
            {
                question: "Which of the following occurs during anaphase I?",
                options: [
                    "Homologous chromosomes move to one pole",
                    "Sister chromatids separate and move to the poles",
                    "Homologous chromosomes move to opposite poles",
                    "Homologous chromosomes align in the middle of the cell"
                ],
                correctAnswer: "Homologous chromosomes move to opposite poles",
                image: null
            },
            {
                question: "In which stage of meiosis does synapsis take place?",
                options: [
                    "Anaphase I",
                    "Metaphase I",
                    "Prophase I",
            ...
            {
                question: "Which of the following shows the importance of meiosis?",
                options: [
                    "It helps in replenishing dead and worn-out cells",
                    "It is responsible for producing sex cells or gametes",
                    "It helps in producing identical copies of daughter cells",
                    "None of the above"
                ],
                correctAnswer: "It is responsible for producing sex cells or gametes",
                image: null
            },
            {
                question: "If a diploid cell with 40 chromosomes underwent mitosis, how many chromosomes would each daughter cell have?",
                options: [
                    "10",
                    "20",
                    "30",
            ...
            {
                question: "A farmer and a gardener want to collaborate for a planting project. They plan to build a harvester's field where they will grow different plants. This project aims to provide food for the less fortunate. In line with this, they must choose to plant high-yield crops that are quick to grow to maintain a sufficient supply of food to harvest. Which of the following groups of crops should they choose to plant to achieve their goal?",
                options: [
                    "Banana, broccoli, tomato",
                    "Mango, eggplant, broccoli",
                    "Taro, sweet potato, spinach",
                    "Cabbage, cauliflower, banana"
                ],
                correctAnswer: "Taro, sweet potato, spinach",
                image: null
            }
        ];
    ...
    methods: {
        ...
        finishQuiz() {
            ...
            const chapterNumber = 5; // Chapter Number
            ...
            const lessonId = 42; // Lesson ID for this quiz
