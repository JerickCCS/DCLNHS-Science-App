...
export default {
    ...
    setup() {
        ...
        const lessonId = lesson ? String(lesson.id) : "78"
  ...
  <div>
    ...
    <p><strong>Earthquake Warning Device</strong></p>
    <p>Earthquakes are inevitable. Presently, there are no reliable warning signs that an
earthquake is about to occur. Your task is to design and create an earthquake warning
device capable of detecting and warning people that an earthquake is coming.</p>
  </div>
  `
        ])
