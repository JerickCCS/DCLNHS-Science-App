...
export default {
    ...
    setup() {
        ...
        const lessonId = lesson ? String(lesson.id) : "74"
...
<p style="text-align:center">Earthquake Preparedness with Smartphones</p>
<div class="video-container">
          <video controls width="100%">
            <source src="assets/videos/chapter 10/lv_0_20260117000617.mp4" controls alt="video" type="video/mp4">
          </video>
          <div class="caption">Technology in Focus: Earthquake Detection</div>
        </div>
