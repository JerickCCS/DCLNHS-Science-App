            ...
            <div v-if="activeTab === 'introduction'" class="introduction-content">
                ...
                <div class="pre-learning-intro">
                    <p>On October 15, 2013, a 7.2-magnitude earthquake hit Bohol and destroyed a number of
                        ...
                        historic churches and landmarks in the province. Based on official reports from the National
                        Disaster Risk Reduction
                        and Management Council (NDRRMC), the effects of the earthquake resulted in about 200 human
                        casualties, with eight
                        persons missing and 976 injured. In this chapter, you will learn about why earthquakes occur,
                        how much damage they can cause, and how to protect yourself during earthquakes..</p>
                </div>
...
export default {
    ...
    setup() {
        ...
        const unitData = reactive({
            ...
            description: "Understand how movements of the Earth's crust cause earthquakes and how faults are formed and classified.",
            objectives: [
        ...
        const lessons = reactive([
            { id: 71, unitId: 4, chapterId: 10, title: "Lesson 1: Earthquakes along Faults", description: "Learn about how earthquakes occur along faults", route: "unit-4-chapter-10-lesson-1", type: "lesson", completed: false, current: true, locked: false },
            { id: 72, unitId: 4, chapterId: 10, title: "Lesson 2: Measuring Earthquakes", description: "Understand how scientists measure earthquake strength", route: "unit-4-chapter-10-lesson-2", type: "lesson", completed: false, current: false, locked: true },
            { id: 73, unitId: 4, chapterId: 10, title: "Lesson 3: Earthquake Preparedness", description: "Learn how to prepare for and stay safe during earthquakes", route: "unit-4-chapter-10-lesson-3", type: "lesson", completed: false, current: false, locked: true },
            { id: 74, unitId: 4, chapterId: 10, title: "Technology in Focus", description: "Explore technology applications in studying earthquakes", route: "chapter-10-technology", type: "special", completed: false, current: false, locked: true },
            { id: 75, unitId: 4, chapterId: 10, title: "Chapter Review", description: "Review key concepts about earthquakes and faults", route: "chapter-10-review", type: "review", completed: false, current: false, locked: true },
            { id: 76, unitId: 4, chapterId: 10, title: "Activity 14: Simulation of an Earthquake", description: "Perform a hands-on simulation of an earthquake", route: "chapter-10-activity", type: "activity", completed: false, current: false, locked: true },
            { id: 77, unitId: 4, chapterId: 10, title: "Chapter Test", description: "Assess your understanding of earthquakes", route: "chapter-10-test", type: "test", completed: false, current: false, locked: true },
            { id: 78, unitId: 4, chapterId: 10, title: "STEM Challenge", description: "Apply your knowledge in a real-world STEM challenge", route: "chapter-10-stem", type: "stem", completed: false, current: false, locked: true }
        ])
