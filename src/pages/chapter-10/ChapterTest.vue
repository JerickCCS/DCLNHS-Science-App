<template>
    <div class="page-container">
        ...
        <header class="header">
            ...
            <h1 class="title">Chapter 10 Test</h1>
        </header>
...
export default {
    data() {
        const quizQuestions = [
            {
                question: "Scientists discovered the presence of a fault. After reviewing the records of occurrences of earthquakes, they found out that the fault has not experienced any geologic activity in the last 10000 years. What type of fault is this?",
                options: [
                    "Active fault",
                    "Inactive fault",
                    "Reverse fault",
                ...
                correctAnswer: "Inactive fault",
                image: null
            },
            {
                question: "Which scale estimates the total energy released by an earthquake?",
                options: [
                    "Seismogram",
                    "Seismograph",
                ...
                correctAnswer: "Richter magnitude scale",
                image: null
            },
            {
                question: "In a _______, the movement is horizontal and parallel to the strike of the fault.",
                options: [
                    "Dip-slip fault",
                    "Strike-slip fault",
                    "Normal fault",
                ...
                correctAnswer: "Strike-slip fault",
                image: null
            },
            {
                question: "Which of the following should you not do after an earthquake occurs when you are inside a building?",
                options: [
                    "Check other people for injuries",
                    "Use a telephone to call someone",
                    "Control small fires from spreading",
                    "Stay away from damaged electrical lines"
                ],
                correctAnswer: "Use a telephone to call someone",
                image: null
            },
            {
            ...
            },
            {
                ...
                correctAnswer: "Moderately strong",
                image: null
            },
            {
                question: "Which of the following is not a primary earthquake hazard?",
                options: [
                    "Ground shaking",
                    "Liquefaction",
                    "Nuclear disaster",
            ...
            {
                question: "Which of the following is not a contributing factor to the degree of ground shaking experienced during an earthquake?",
                options: [
                    "Distance from the epicenter",
                    "Proximity to bodies of water",
                    "Magnitude of the earthquake",
                    "Nature of underlying rocks and soil"
                ],
                correctAnswer: "Proximity to bodies of water",
                image: null
            },
            {
                question: "Which of the following does not explain why the Philippines is considered one of the most tectonically and seismically active places on Earth?",
                options: [
            ...
            {
                question: "In 1996, PHIVOLCS adopted the PEIS, which succeeded the _______.",
                options: [
                ...
                correctAnswer: "Rossi-Forel scale",
                image: null
            },
            {
                question: "You were strolling at the park when an earthquake occurred. The strong force of the earthquake caused you to lose your balance. Some of the old houses in your surroundings were slightly damaged. Based on what you have experienced, what is the intensity of the earthquake in the PHIVOLCS Earthquake Intensity Scale?",
                options: [
                    "Intensity I",
                    "Intensity III",
                    "Intensity VI",
    ...
    methods: {
        ...
        finishQuiz() {
            ...
            const chapterNumber = 10; // Chapter Number
            ...
            const lessonId = 77; // Lesson ID for this quiz
