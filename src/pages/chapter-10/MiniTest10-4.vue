...
const questions = ref([
    {
        id: 'q1',
        question: 'What happens to earthquake intensity as you move farther from the epicenter?',
        options: [
            { id: 'a', text: 'Intensity increases' },
            { id: 'b', text: 'Intensity decreases' },
            { id: 'c', text: 'Intensity stays the same' },
            { id: 'd', text: 'Intensity becomes unpredictable' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q2',
        question: 'Which of these best defines an earthquake?',
        options: [
            { id: 'a', text: 'A sudden shaking of the ground caused by energy release from seismic waves' },
            { id: 'b', text: 'A large wave in the ocean' },
            { id: 'c', text: 'Movement of tectonic plates only' },
            { id: 'd', text: 'A weather phenomenon that causes ground motion' }
        ],
        correctAnswer: 'a'
    }
])
