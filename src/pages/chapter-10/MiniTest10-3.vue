...
const questions = ref([
    {
        id: 'q1',
        question: 'What is the main difference between active and inactive faults?',
        options: [
            { id: 'a', text: 'Active faults can produce earthquakes, inactive faults cannot' },
            { id: 'b', text: 'Active faults are visible, inactive faults are hidden' },
            { id: 'c', text: 'Active faults are always moving, inactive faults never move' },
            { id: 'd', text: 'Active faults are wider, inactive faults are narrower' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q2',
        question: 'What is a major risk of living near an active fault?',
        options: [
            { id: 'a', text: 'Increased water bills' },
            { id: 'b', text: 'Earthquake damage to buildings and infrastructure' },
            { id: 'c', text: 'Poor cell phone reception' },
            { id: 'd', text: 'Higher property taxes' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q3',
        question: 'How can communities learn about earthquake risks from faults?',
        options: [
            { id: 'a', text: 'Through community education programs and earthquake drills' },
            { id: 'b', text: 'By guessing based on weather patterns' },
            { id: 'c', text: 'From social media rumors' },
            { id: 'd', text: 'By avoiding the topic completely' }
        ],
        correctAnswer: 'a'
    }
])
