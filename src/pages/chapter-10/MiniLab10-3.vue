...
const questions = ref([
    {
        id: 'q1',
        question: 'Differentiate active fault from inactive fault.',
        options: [
            { id: 'a', text: 'Active faults can still move and cause earthquakes, while inactive faults have not moved in a long time' },
            { id: 'b', text: 'Active faults are bigger than inactive faults' },
            { id: 'c', text: 'Inactive faults are more dangerous than active faults' },
            { id: 'd', text: 'Active faults are only found underwater, while inactive faults are on land' }
        ],
        correctAnswer: 'd'  // Changed from 'a'
    },
    {
        id: 'q2',
        question: 'What are the dangers or risks of living near an active fault?',
        options: [
            { id: 'a', text: 'Earthquakes that can damage buildings, cause injuries, and create other hazards like landslides' },
            { id: 'b', text: 'The ground might suddenly open and swallow houses whole' },
            { id: 'c', text: 'Increased chance of volcanic eruptions occurring' },
            { id: 'd', text: 'The air becomes toxic and hard to breathe' }
        ],
        correctAnswer: 'b'  // Changed from 'a'
    },
    {
        id: 'q3',
        question: 'How can you help your community learn about faults as earthquake generators?',
        options: [
            { id: 'a', text: 'Organize earthquake drills, share information, and participate in community education programs' },
            { id: 'b', text: 'Tell everyone to move to a different city' },
            { id: 'c', text: 'Ignore the issue to avoid causing panic' },
            { id: 'd', text: 'Only scientists should talk about earthquake risks' }
        ],
        correctAnswer: 'c'  // Changed from 'a'
    }
])
