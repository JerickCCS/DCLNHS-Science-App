    ...
    <q-page class="chapters-page">
        ...
        <div class="page-header bg-white">
            <q-toolbar class="center-toolbar">
                ...
                <div class="toolbar-title text-primary">Unit III</div>
            </q-toolbar>
        </div>
...
.main-img {
    ...
    height: auto;
    border-radius: 16px;
    box-shadow: 0 8px 0 0 rgb(127, 133, 136);
}

/* ---------- Description ---------- */
.unit-description {
    background: linear-gradient(135deg, #5d17eb, #8E24AA);
    color: white;
    border-radius: 16px;
    padding: 20px;
    margin-bottom: 90px;
    box-shadow: 0 8px 0 0 #3d12a0;
    position: relative;
}
