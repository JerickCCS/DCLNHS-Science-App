    ...
    <q-page class="chapters-page">
        ...
        <div class="hero-section">
            ...
            <div class="hero-image-wrap">
                <img src="assets/temp/Forces in Action.png" alt="Unit III" class="hero-img" />
                <div class="hero-img-glow"></div>
            </div>

            <!-- Unit badge + title -->
            <div class="hero-meta">
                <span class="unit-badge">Unit III</span>
                <h1 class="unit-title">Forces in Action</h1>
        ...
        <div class="desc-card">
            <div class="desc-title-row">
                <p class="desc-title">Forces in Action</p>
            ...
            <p class="desc-text">
                Whether we are tossing a ball or simply walking down the street, invisible forces are at play, shaping
                how things move. These forces have a direct impact on the way objects behave, and by delving into them,
                we unlock a whole new level of understanding about motion.
            </p>
            <p class="desc-text">
                Unit III consists of three chapters. Chapter 7 discusses balanced and unbalanced forces and their
                influence on the motion of objects. Chapter 8 explores ways to describe motion in a straight line using
                the quantities such as distance, displacement, speed, and velocity. Finally, Chapter 9 focuses on the
                concepts of internal energy, temperature, heat, and how heat moves from one object to another.
            </p>
...
const descContent = `Forces in Action
Whether we are tossing a ball or simply walking down the street, invisible forces are at play, shaping how things move. These forces have a direct impact on the way objects behave, and by delving into them, we unlock a whole new level of understanding about motion.
Unit III consists of three chapters. Chapter 7 discusses balanced and unbalanced forces and their influence on the motion of objects. Chapter 8 explores ways to describe motion in a straight line using the quantities such as distance, displacement, speed, and velocity. Finally, Chapter 9 focuses on the concepts of internal energy, temperature, heat, and how heat moves from one object to another.`
