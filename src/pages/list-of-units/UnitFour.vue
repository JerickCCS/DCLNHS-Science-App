    ...
    <q-page class="chapters-page">
        ...
        <div class="hero-section">
            ...
            <div class="hero-image-wrap">
                <img src="assets/temp/Earth and Space.png" alt="Unit IV" class="hero-img" />
                <div class="hero-img-glow"></div>
            </div>

            <!-- Unit badge + title -->
            <div class="hero-meta">
                <span class="unit-badge">Unit IV</span>
                <h1 class="unit-title">Earth and Space Science</h1>
        ...
        <div class="desc-card">
            <div class="desc-title-row">
                <p class="desc-title">Earth and Space Science</p>
            ...
            <p class="desc-text">
                Earth has a unique atmosphere that allows life to flourish. Its atmosphere also protects life on Earth
                from the possible impact of comets, meteoroids, and asteroids when they enter our atmosphere. However,
                natural processes in the atmosphere may damage life on Earth. Typhoons, for example, bring heavy rains
                that can flood low-lying areas, claim lives, and destroy properties. There are also processes that occur
                within Earth that are as life-threatening as the processes on its surface. These can cause natural
                hazards such as earthquakes.
            </p>
            <p class="desc-text">
                Unit IV tackles the possible threats to life on Earth. Chapter 10 examines earthquakes and faults.
                Chapter 11 deals with events that occur in the atmosphere. Chapter 12 provides a discussion on why
                seasons occur.
            </p>

            <div class="desc-chips">
                <div class="desc-chip chip-blue">
                    <q-icon name="vibration" size="14px" />
...
const descContent = `Earth and Space Science
Earth has a unique atmosphere that allows life to flourish. Its atmosphere also protects life on Earth from the possible impact of comets, meteoroids, and asteroids when they enter our atmosphere. However, natural processes in the atmosphere may damage life on Earth. Typhoons, for example, bring heavy rains that can flood low-lying areas, claim lives, and destroy properties. There are also processes that occur within Earth that are as life-threatening as the processes on its surface. These can cause natural hazards such as earthquakes.
Unit IV tackles the possible threats to life on Earth. Chapter 10 examines earthquakes and faults. Chapter 11 deals with events that occur in the atmosphere. Chapter 12 provides a discussion on why seasons occur.`
