...
const questions = ref([
    {
        id: 'q1',
        question: 'Using the rule of ten, if plants in an ecosystem contain 10,000 kcal of energy, how much energy would be available to a secondary consumer like a frog?',
        options: [
            { id: 'a', text: '10,000 kcal — the same amount as the plants' },
            { id: 'b', text: '1,000 kcal — after one transfer of 10%' },
            { id: 'c', text: '100 kcal — after two transfers of 10% each' },
            { id: 'd', text: '10 kcal — after three transfers of 10% each' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q2',
        question: 'An omnivore usually feeds at the fourth trophic level but moves down to eat at the second trophic level instead. What happens to the amount of energy it receives?',
        options: [
            { id: 'a', text: 'It receives less energy because higher trophic levels always have more energy' },
            { id: 'b', text: 'It receives more energy because it is now closer to the producers where more energy is available' },
            { id: 'c', text: 'It receives the same amount of energy regardless of trophic level' },
            { id: 'd', text: 'It receives no energy because omnivores can only feed at higher trophic levels' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q3',
        question: 'What is the main difference between a pyramid of numbers and a pyramid of biomass?',
        options: [
            { id: 'a', text: 'A pyramid of numbers counts individual organisms at each level, while a pyramid of biomass measures the total mass of all organisms at each level' },
            { id: 'b', text: 'A pyramid of numbers measures energy while a pyramid of biomass counts individual organisms' },
            { id: 'c', text: 'Both pyramids measure exactly the same thing but are drawn differently' },
            { id: 'd', text: 'A pyramid of biomass only applies to aquatic ecosystems while a pyramid of numbers applies to land ecosystems' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q4',
        question: 'In some aquatic ecosystems, the biomass pyramid is inverted — meaning there is more biomass in consumers than in producers. What best explains this?',
        options: [
            { id: 'a', text: 'Aquatic producers do not photosynthesize so they cannot build up biomass' },
            { id: 'b', text: 'Phytoplankton grows so rapidly that even though zooplankton consumes it faster, the phytoplankton keeps replenishing quickly' },
            { id: 'c', text: 'Consumers in aquatic ecosystems produce their own energy unlike land consumers' },
            { id: 'd', text: 'Aquatic food chains have no decomposers so energy builds up in consumers instead' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q5',
        question: 'A cow eats 1,000 kcal of energy from grass. A human then eats the beef from that cow. How much energy from the original grass does the human actually get to use?',
        options: [
            { id: 'a', text: '1,000 kcal — the full amount from the grass' },
            { id: 'b', text: '100 kcal — since the cow already used 90% of the grass energy' },
            { id: 'c', text: '10 kcal — since only 10% passes from the cow to the human' },
            { id: 'd', text: '500 kcal — since energy is split equally between the cow and the human' }
        ],
        correctAnswer: 'c'
    }
])
