...
const questions = ref([
    {
        id: 'q1',
        question: 'A food chain goes: Grass → Grasshopper → Mouse → Snake → Eagle. What does this food chain tell us about how energy moves in an ecosystem?',
        options: [
            { id: 'a', text: 'Energy moves randomly between organisms with no specific order' },
            { id: 'b', text: 'Energy is passed from one organism to the next as each one eats the organism below it' },
            { id: 'c', text: 'Only the eagle receives energy since it is at the top of the food chain' },
            { id: 'd', text: 'All organisms in a food chain receive the same amount of energy' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q2',
        question: 'A carnivore like a snake eats frogs, which eat insects, which eat grass. Why is grass just as important as frogs in the diet of the snake?',
        options: [
            { id: 'a', text: 'Because the snake can eat grass directly when frogs are not available' },
            { id: 'b', text: 'Because without grass, the insects and frogs would have nothing to eat, and the snake would eventually have no food either' },
            { id: 'c', text: 'Because grass provides more energy to the snake than frogs do' },
            { id: 'd', text: 'Because grass and frogs are the same trophic level in the food chain' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q3',
        question: 'What is the correct order of trophic levels in an ecosystem?',
        options: [
            { id: 'a', text: 'Consumers → Producers → Decomposers' },
            { id: 'b', text: 'Decomposers → Consumers → Producers' },
            { id: 'c', text: 'Producers → Primary Consumers → Secondary Consumers → Tertiary Consumers → Decomposers' },
            { id: 'd', text: 'Primary Consumers → Producers → Secondary Consumers' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q4',
        question: 'A food web is more accurate than a food chain in describing an ecosystem. Why?',
        options: [
            { id: 'a', text: 'Because a food web only shows the most important organisms in an ecosystem' },
            { id: 'b', text: 'Because most organisms eat more than one type of food, and a food web shows all those feeding relationships together' },
            { id: 'c', text: 'Because a food web is simpler and easier to understand than a food chain' },
            { id: 'd', text: 'Because a food web only includes producers and ignores consumers' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q5',
        question: 'In an energy pyramid, why are there fewer organisms at the top compared to the bottom?',
        options: [
            { id: 'a', text: 'Because top predators are too big to fit at the bottom of the pyramid' },
            { id: 'b', text: 'Because organisms at the top are less important to the ecosystem' },
            { id: 'c', text: 'Because only 10% of energy is passed to the next trophic level, so there is much less energy available for top consumers' },
            { id: 'd', text: 'Because producers intentionally limit the energy they give to consumers' }
        ],
        correctAnswer: 'c'
    }
])
