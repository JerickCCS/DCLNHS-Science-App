<template>
    <div class="page-container">
        ...
        <header class="header">
            ...
            <h1 class="title">Chapter 6 Test</h1>
        </header>
...
export default {
    data() {
        const quizQuestions = [
            {
                question: "How does an ecosystem become dynamic?",
                options: [
                    "Living organisms dominate their environment",
                    "An organism and its environment both affect each other",
                    "A balance between the organisms and the environment exists",
                    "Both B and C"
                ],
            ...
            {
                question: "Which set consists only of nonliving environmental factors?",
                options: [
                    "Plants, air, food, water",
                    "Humans, plants, animals",
                    "Minerals, soil, water, light",
                    "Soil, earthworms, water, snakes"
                ],
                correctAnswer: "Minerals, soil, water, light",
                image: null
            },
            {
                question: "What happens to the energy in an ecosystem?",
                options: [
                    "It flows throughout the system",
                    "It is contained within the ecosystem",
                    "It is recycled all throughout the environment",
                    "All of the above"
                ],
                correctAnswer: "It flows throughout the system",
                image: null
            },
            {
                question: "Which of the following sets are in correct order from the simplest to the most complex?",
                options: [
                    "Population → ecosystem → community → biosphere → biome",
                    "Community → population → ecosystem → biome → biosphere",
                    "Population → community → ecosystem → biome → biosphere",
                    "Community → ecosystem → population → biosphere → biome"
                ],
                correctAnswer: "Population → community → ecosystem → biome → biosphere",
                image: null
            },
            {
                question: "What will happen if there are no decomposers in the environment?",
                options: [
                    "Plant populations will decrease",
                    "Animals would have difficulty getting food",
                    "Dead organisms will not be broken down for energy",
                    "The environment will not be able to sustain its abiotic factors"
                ],
                correctAnswer: "Dead organisms will not be broken down for energy",
                image: null
            },
            {
                question: "Which organism converts light energy into chemical energy?",
                options: [
                    "Grass",
                    "Owl",
                    "Rat",
            ...
            {
                question: "Which best describes the relationship between the different levels of organization?",
                options: [
                    "They are independent of each other",
                    "They are connected and thus, affect each other",
                    "They are connected but can exist without the other",
                    "They perform roles that can only affect the level next to it"
                ],
                correctAnswer: "They are connected and thus, affect each other",
                image: null
            },
            {
                question: "Decomposers are essential for the cycling of nutrients. Where would you place the decomposers in a food chain?",
                options: [
                    "Before the producers",
                    "After the producers",
                    "In between the consumers",
                    "Connected to all trophic levels"
                ],
                correctAnswer: "Connected to all trophic levels",
                image: null
            },
            {
                question: "How much energy will be left for organisms that will consume the omnivores in the pyramid? (Based on the energy pyramid description)",
                options: [
                    "5.52 kcal",
                    "5.525 kcal",
                    "5.552 kcal",
                ...
                correctAnswer: "0.552 kcal",
                image: null
            },
            {
                question: "What will happen if the omnivores directly eat the producers?",
                options: [
                    "They will obtain a lower amount of energy",
                    "They will obtain a higher amount of energy",
                    "They will obtain the same amount of energy",
                    "None of the above"
                ],
                correctAnswer: "They will obtain a higher amount of energy",
                image: null
            }
        ];
    ...
    methods: {
        ...
        finishQuiz() {
            ...
            const chapterNumber = 6; // Chapter Number
            ...
            const lessonId = 48; // Lesson ID for this quiz
