...
const questions = ref([
    {
        id: 'q1',
        question: 'What is the correct order of biological organization from simplest to most complex?',
        options: [
            { id: 'a', text: 'Organism → Tissue → Cell → Organ → Organ System → Population → Community → Ecosystem → Biosphere' },
            { id: 'b', text: 'Cell → Tissue → Organ → Organ System → Organism → Population → Community → Ecosystem → Biosphere' },
            { id: 'c', text: 'Cell → Organ → Tissue → Organism → Organ System → Population → Ecosystem → Community → Biosphere' },
            { id: 'd', text: 'Biosphere → Ecosystem → Community → Population → Organism → Organ System → Organ → Tissue → Cell' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q2',
        question: 'A decaying log has fungi breaking down the wood, insects living inside it, bacteria decomposing organic matter, and moisture keeping everything alive. Can a decaying log be considered an ecosystem?',
        options: [
            { id: 'a', text: 'No, because an ecosystem must be large like a forest or ocean' },
            { id: 'b', text: 'No, because a decaying log only has dead matter and no living organisms' },
            { id: 'c', text: 'Yes, because it has both living organisms (biotic) and nonliving factors (abiotic) interacting with each other' },
            { id: 'd', text: 'Yes, but only if it contains at least one animal and one plant species' }
        ],
        correctAnswer: 'c'
    },
    {
        ...
        options: [
            { id: 'a', text: 'A population includes all living and nonliving things, while a community only includes living organisms' },
            { id: 'b', text: 'A population is a group of the same species in one area, while a community is made up of different species living and interacting in the same area' },
            { id: 'c', text: 'A population is larger than a community because it covers a wider geographic area' },
            { id: 'd', text: 'A population and a community are the same thing, just different terms for the same level' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q4',
        question: 'Why is it important to learn about the different levels of biological organization?',
        options: [
            { id: 'a', text: 'Because it helps us understand how the simplest parts of life connect and build up to form the most complex systems in the living world' },
            { id: 'b', text: 'Because it teaches us how to classify organisms based on their size alone' },
            { id: 'c', text: 'Because it helps scientists count the exact number of organisms in the biosphere' },
            { id: 'd', text: 'Because it shows us that each level of organization works independently without affecting the others' }
        ],
        correctAnswer: 'a'
    }
])
