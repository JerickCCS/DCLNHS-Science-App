...
const questions = ref([
    {
        id: 'q1',
        question: 'Dry ice (solid CO₂) sublimes at room temperature. The diagrams A-D show particle arrangements. Which diagram best represents the sublimation process of dry ice turning directly into a gas?',
        image: 'assets/img/chapter 2/minitest2-4.png',
        options: [
            { id: 'a', text: 'Figure A (Solid to Gas)' },
            { id: 'b', text: 'Figure B (Liquid to Gas)' },
            { id: 'c', text: 'Figure C (Solid to Liquid)' },
            { id: 'd', text: 'Figure D (Gas to Solid)' }
        ],
        correctAnswer: 'a'
    }
])
