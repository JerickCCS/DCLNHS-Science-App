...
export default {
    data() {
        const quizQuestions = [
            {
                question: "Why do scientists use models in their investigation?",
                options: [
                    "To replace actual experiments",
                    "To make their experiments more colorful",
                    "To impress the public with advanced technology",
                    "To explain phenomena that are difficult to see or detect"
                ],
                correctAnswer: "To explain phenomena that are difficult to see or detect",
                image: null
            },
            {
                question: "How does the particle model of matter explain the nature of different pure substances?",
                options: [
                    "Substances have different-sized particles",
                    "Particles in substances are always visible",
                    "All substances share the same kind of particles",
                    "Different substances have their own kind of particles"
                ],
                correctAnswer: "Different substances have their own kind of particles",
                image: null
            },
            {
                question: "Which of the following is not a basic principle of the particle nature of matter?",
                options: [
                ...
                correctAnswer: "Particles of matter are stationary",
                image: null
            },
            {
                question: "Which statement best explains why liquids flow?",
                options: [
                    "The particles occupy a unit volume",
                    "Their particles slide past one another",
                    "Their particles are in constant motion",
                    "They are made up of tiny, discrete particles"
                ],
                correctAnswer: "Their particles slide past one another",
                image: null
            },
            {
                question: "Which is a result of the particles of gases being far apart?",
                options: [
                ...
                correctAnswer: "Gases are compressible",
                image: null
            },
            {
                question: "Which best explains why solids are the densest among the three states of matter?",
                options: [
                    "Their particles cannot move freely",
                    "Their particles vibrate in fixed positions",
                    "They have the most number of particles per unit volume",
                    "They have the strongest attractive force between particles"
                ],
                correctAnswer: "They have the most number of particles per unit volume",
                image: null
            },
            {
                question: "If a substance is cooled, what will happen to its particles?",
                options: [
                    "They will move farther apart",
                    "They will move closer together",
                    "They will spread more randomly",
                    "They will spread in any direction"
                ],
                correctAnswer: "They will move closer together",
                image: null
            },
            {
                question: "What happens when water changes state from liquid into gas?",
                options: [
                    "The water particles lose motion energy",
                    "The water particles dissociate into hydrogen and oxygen gases",
                    "The water particles have greater attractive forces between them",
                    "The water particles move faster and farther away from one another"
                ],
                correctAnswer: "The water particles move faster and farther away from one another",
                image: null
            },
            {
                question: "Which represent(s) an element?",
                options: [
                    "I only",
                    "II only",
                    "I and II",
                ...
                image: null // Could add image path if you have a diagram
            },
            {
                question: "Which represent(s) a pure substance?",
                options: [
                    "I only",
                    "II only",
                    "I, II, and III",
            ...
            {
                question: "Which represents a mixture?",
                options: [
                    "I",
                    "II",
                    "III",
            ...
            {
                question: "If a substance absorbs heat, what will happen to the motion energy of its particles?",
                options: [
                    "It will increase",
                    "It will decrease",
                ...
                correctAnswer: "It will increase",
                image: null
            }
        ];
    ...
    methods: {
        ...
        finishQuiz() {
            ...
            const chapterNumber = 2; // Chapter Number
            ...
            const lessonId = 14; // Lesson ID for this quiz
