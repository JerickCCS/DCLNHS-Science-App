...
const questions = ref([
    {
        id: 'q1',
        question: 'If a solid substance in a container is heated, what will be the arrangement of its particles when the substance melts and becomes liquid? Choose from the figures below (A to C) and explain your choice.',
        image: 'assets/img/chapter 2/abc.png', // change path as needed
        options: [
            { id: 'a', text: 'Figure A' },
            { id: 'b', text: 'Figure B' },
            { id: 'c', text: 'Figure C' }
    ...
    {
        id: 'q2',
        question: 'If the melted substance in item 1 is heated continuously until it comes to a boil, what will be the arrangement of the particles as the substance becomes gas?',
        image: 'assets/img/chapter 2/abc.png', // same or different image
        options: [
            { id: 'a', text: 'Figure A' },
            { id: 'b', text: 'Figure B' },
            { id: 'c', text: 'Figure C' }
