...
export default {
    ...
    setup() {
        ...
        const lessons = reactive([
            { id: 9, unitId: 1, chapterId: 2, title: "Lesson 1: The Particles of Matter", description: "Learn about the particles that make up matter", route: "unit-1-chapter-2-lesson-1", type: "lesson", completed: false, current: true, locked: false },
            { id: 10, unitId: 1, chapterId: 2, title: "Lesson 2: The Particle Nature of the Three States of Matter", description: "Understand how particles behave in solids, liquids, and gases", route: "unit-1-chapter-2-lesson-2", type: "lesson", completed: false, current: false, locked: true },
            { id: 11, unitId: 1, chapterId: 2, title: "Technology in Focus", description: "Explore technology related to the study of matter", route: "chapter-2-technology", type: "special", completed: false, current: false, locked: true },
            { id: 12, unitId: 1, chapterId: 2, title: "Chapter Review", description: "Review and summarize key concepts", route: "chapter-2-review", type: "review", completed: false, current: false, locked: true },
            { id: 13, unitId: 1, chapterId: 2, title: "Activity 2: The Particle Nature of Matter", description: "Hands-on activity exploring the nature of particles", route: "chapter-2-activity", type: "activity", completed: false, current: false, locked: true },
            { id: 14, unitId: 1, chapterId: 2, title: "Chapter Test", description: "Evaluate your understanding of the chapter", route: "chapter-2-test", type: "test", completed: false, current: false, locked: true },
            { id: 15, unitId: 1, chapterId: 2, title: "STEM Challenge", description: "Apply what you've learned through a real-world challenge", route: "chapter-2-stem", type: "stem", completed: false, current: false, locked: true }
        ])
