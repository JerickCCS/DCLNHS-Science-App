...
export default {
    ...
    setup() {
        ...
        const lessonId = lesson ? String(lesson.id) : "11"
    ...
    <div>
      ...
      <p>Nanoparticles are extremely small particles that fall within the range of 1 to 100 nanometers (nm) in size. These particles cannot be seen by the naked eye and can exhibit different properties than their larger counterparts. Manipulating materials in the nanoscale explores the particle nature of matter, enabling scientists to create and customize materials with specific functions and properties. Advanced microscopes are required for observation and analysis of distinct characteristics of nanoparticles such as their surface area and composition. These small particles hold immense promise and are incredibly valuable in various industries, including medicine, electronics, and environmental solutions. For example, scientists utilize them to administer medicine with precision, improve electronic devices, and even mitigate pollutants in the environment.</p>
    </div>
    `,
            `
    <div>
