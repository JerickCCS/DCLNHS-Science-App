...
const questions = ref([
    {
        id: 'q1',
        question: 'When sugar dissolves completely in water, what happens to the sugar particles?',
        options: [
            { id: 'a', text: 'The sugar particles disappear completely' },
            { id: 'b', text: 'The sugar particles become water particles' },
            { id: 'c', text: 'The sugar particles break apart and spread between water particles' },
            { id: 'd', text: 'The sugar particles sink to the bottom in very small pieces' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q2',
        question: 'How would you describe the particle arrangement in the sugar-water solution?',
        options: [
            { id: 'a', text: 'Sugar particles form a separate layer at the bottom' },
            { id: 'b', text: 'Sugar and water particles mix evenly throughout the solution' },
            { id: 'c', text: 'Sugar particles clump together in the middle' },
            { id: 'd', text: 'Water particles surround but do not mix with sugar particles' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q3',
        question: 'What does the dissolving of sugar in water demonstrate about particles of matter?',
        options: [
            { id: 'a', text: 'Particles have no spaces between them' },
            { id: 'b', text: 'Particles are too small to see but there are spaces between them' },
            { id: 'c', text: 'Particles cannot mix with other types of particles' },
            { id: 'd', text: 'Particles only move when heated' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q4',
        question: 'Why can sugar particles fit between water particles when they dissolve?',
        options: [
            { id: 'a', text: 'Because both sugar and water particles are the same size' },
            { id: 'b', text: 'Because water particles make space for sugar particles by disappearing' },
            { id: 'c', text: 'Because there are spaces between water particles where sugar particles can fit' },
            { id: 'd', text: 'Because sugar particles are bigger than water particles' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q5',
        question: 'What evidence from the experiment supports the idea that particles have spaces between them?',
        options: [
            { id: 'a', text: 'The water changes color when sugar is added' },
            { id: 'b', text: 'The sugar disappears completely without increasing the water level much' },
            { id: 'c', text: 'The glass becomes heavier when sugar is added' },
            { id: 'd', text: 'The water tastes sweet after stirring' }
        ],
        correctAnswer: 'b'
    }
])
