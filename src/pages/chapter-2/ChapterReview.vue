...
export default {
    ...
    setup() {
        ...
        const lessonId = lesson ? String(lesson.id) : "12"
    ...
    <div>
      ...
      <p>• The particle nature of matter has four basic principles:<br>
      - Matter is made up of discrete particles.<br>
      - There are empty spaces between the particles.<br>
      - The particles are in constant motion.<br>
      - Forces act between the particles.<br>
      • The particle nature of solids, liquids, and gases can fully explain the observable differences among these three states of matter.<br>
      • Elements, compounds, and mixtures and their state changes can be represented by their particle composition.</p>
    </div>
    `
        ])
