            ...
            <q-page class="q-pa-md" style="background-color: #f8f9fa;">
                ...
                <div class="section">
                    ...
                    <div v-if="currentQuestion" class="questions-container">
                        ...
                        <div v-if="currentQuestion.image" class="question-image-container q-mb-md">
                            <img :src="currentQuestion.image"
                                :alt="'Diagram for Question ' + (currentQuestionIndex + 1)" class="question-image" />
                        </div>
...
const questions = ref([
    {
        id: 'q1',
        question: 'What is the key difference between internal energy and heat?',
        options: [
            { id: 'a', text: 'Internal energy is measured in degrees; heat is measured in joules' },
            { id: 'b', text: 'Internal energy is the total energy contained in a body; heat is the transfer of that energy between bodies' },
            { id: 'c', text: 'Internal energy only exists in hot objects; heat only exists in cold objects' },
    ...
    {
        id: 'q2',
        question: 'Under what condition does heat transfer take place between two bodies?',
        options: [
            { id: 'a', text: 'When the two bodies have the same mass' },
            { id: 'b', text: 'When the two bodies are made of the same material' },
            { id: 'c', text: 'When there is a temperature difference between the two bodies' },
            { id: 'd', text: 'When both bodies are in motion' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q3',
        question: 'Objects A and B are made of the same material and have achieved thermal equilibrium after contact. Are their temperatures the same?',
        options: [
            { id: 'a', text: 'No, object A is always warmer' },
            { id: 'b', text: 'No, object B is always warmer' },
            { id: 'c', text: 'Yes, at thermal equilibrium their temperatures are equal' },
            { id: 'd', text: 'It depends on which object was initially hotter' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q4',
        question: 'Objects A and B are made of the same material but object A is larger than object B. After reaching thermal equilibrium, how do their internal energies compare?',
        options: [
            { id: 'a', text: 'Object A has greater internal energy because it has more mass' },
            { id: 'b', text: 'Object B has greater internal energy because it lost heat' },
            { id: 'c', text: 'Their internal energies are equal because they have the same temperature' },
            { id: 'd', text: 'Internal energy cannot be compared after thermal equilibrium' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q5',
        question: 'When does heat transfer between two bodies in contact stop?',
        options: [
            { id: 'a', text: 'When one body runs out of internal energy' },
            { id: 'b', text: 'When both bodies reach the same temperature (thermal equilibrium)' },
            { id: 'c', text: 'When both bodies have the same mass' },
            { id: 'd', text: 'Heat transfer never stops completely' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q6',
        question: 'Ice absorbs heat when it melts, yet its temperature stays at 0°C. What does this tell us?',
        options: [
            { id: 'a', text: 'Heat and temperature are always directly proportional' },
            { id: 'b', text: 'A change in internal energy does not always cause a change in temperature' },
            { id: 'c', text: 'Ice does not actually absorb heat when it melts' },
            { id: 'd', text: 'Temperature only changes when mass changes' }
        ],
        correctAnswer: 'b'
    }
])
