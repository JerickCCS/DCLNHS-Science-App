...
const questions = ref([
    {
        id: 'q1',
        question: 'Two objects have the same mass and temperature. How do their internal energies compare?',
        options: [
            { id: 'a', text: 'Object A has more internal energy than object B' },
            { id: 'b', text: 'Object B has more internal energy than object A' },
            { id: 'c', text: 'Their internal energies are equal' },
            { id: 'd', text: 'Their internal energies cannot be compared' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q2',
        question: 'What happens to the temperature of a substance when it is heated?',
        options: [
            { id: 'a', text: 'It decreases' },
            { id: 'b', text: 'It stays the same' },
            { id: 'c', text: 'It increases' },
            { id: 'd', text: 'It first increases then decreases' }
        ],
        correctAnswer: 'c'
    },
    {
        ...
        options: [
            ...
            { id: 'b', text: 'It stays the same' },
            { id: 'c', text: 'It increases' },
            { id: 'd', text: 'It depends on the mass of the substance' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q4',
        question: 'A cup of water and a kettle of water are both at 30°C. Which has greater internal energy?',
        options: [
            { id: 'a', text: 'The cup of water' },
            { id: 'b', text: 'The kettle of water' },
            { id: 'c', text: 'They have the same internal energy' },
    ...
    {
        id: 'q5',
        question: 'Which best explains why the kettle of water at 30°C has greater internal energy than a cup of water at 30°C?',
        options: [
            { id: 'a', text: 'The kettle has a higher temperature' },
            { id: 'b', text: 'The kettle contains more particles, so its total energy is greater' },
            { id: 'c', text: 'The particles in the kettle move faster' },
            { id: 'd', text: 'The kettle transfers more heat to the surroundings' }
        ],
        correctAnswer: 'b'
    }
])
