...
const questions = ref([
    {
        id: 'q1',
        question: 'The sun provides warmth to a person standing under its light. What mode of heat transfer is involved?',
        options: [
    ...
    {
        id: 'q2',
        question: 'Which method of heat transfer distributes warm air from sunlight throughout an entire house?',
        options: [
            { id: 'a', text: 'Conduction' },
            { id: 'b', text: 'Convection' },
            { id: 'c', text: 'Radiation' },
            { id: 'd', text: 'Conduction and Radiation' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q3',
        question: 'When roasting marshmallows, it is better to use a tree twig than a metal rod, as the rod can get very hot and difficult to hold. What mode of heat transfer explains this?',
        options: [
            { id: 'a', text: 'Radiation' },
            { id: 'b', text: 'Convection' },
            { id: 'c', text: 'Conduction' },
            { id: 'd', text: 'Convection and Radiation' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q4',
        question: 'To prevent ice from melting, a cooler is used. Which mode of heat transfer is the cooler primarily blocking?',
        options: [
            { id: 'a', text: 'Convection only' },
            { id: 'b', text: 'Radiation only' },
            { id: 'c', text: 'Conduction only' },
            { id: 'd', text: 'Conduction, Convection, and Radiation' }
        ],
        correctAnswer: 'd'
    },
    {
        id: 'q5',
        question: 'Earth emits heat into space. What mode of heat transfer allows this to occur even through the vacuum of space?',
        options: [
            { id: 'a', text: 'Conduction' },
            { id: 'b', text: 'Convection' },
            { id: 'c', text: 'Radiation' },
    ...
    {
        id: 'q6',
        question: 'Heat from Earth\'s interior moves through the crust to the surface, leading to earthquakes and volcano formation. What mode of heat transfer is this?',
        options: [
            { id: 'a', text: 'Radiation' },
            { id: 'b', text: 'Convection' },
            { id: 'c', text: 'Conduction' },
            { id: 'd', text: 'Radiation and Conduction' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q7',
        question: 'An electric fan makes air move faster in a room, enhancing the transfer of warmth from your body into the air. What mode of heat transfer is being enhanced?',
        options: [
            { id: 'a', text: 'Conduction' },
            { id: 'b', text: 'Convection' },
            { id: 'c', text: 'Radiation' },
    ...
    {
        id: 'q8',
        question: 'The global movement of the ocean helps distribute heat throughout Earth. What mode of heat transfer does this represent?',
        options: [
            { id: 'a', text: 'Conduction' },
            { id: 'b', text: 'Radiation' },
    ...
    {
        id: 'q9',
        question: 'When you step on a tile, heat transfers more easily from your feet onto the tile than onto a carpet. What mode of heat transfer is this?',
        options: [
            { id: 'a', text: 'Radiation' },
            { id: 'b', text: 'Convection' },
            { id: 'c', text: 'Conduction' },
    ...
    {
        id: 'q10',
        question: 'Glider pilots utilize "thermals" — upward currents of warm air — to ascend to higher altitudes. What mode of heat transfer creates these thermals?',
        options: [
            { id: 'a', text: 'Conduction' },
            { id: 'b', text: 'Convection' },
            { id: 'c', text: 'Radiation' },
