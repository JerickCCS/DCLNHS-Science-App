...
const questions = ref([
    {
        id: 'q1',
        question: 'In step 1 of the mini lab, how does the temperature of your palm compare to the temperature of the ice cube?',
        options: [
            { id: 'a', text: 'The palm is cooler than the ice cube' },
            { id: 'b', text: 'The palm is warmer than the ice cube' },
            { id: 'c', text: 'The palm and the ice cube have the same temperature' },
            { id: 'd', text: 'The temperatures cannot be compared' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q2',
        question: 'In step 2, how do the temperatures of the two ice cubes inside the freezer compare?',
        options: [
            { id: 'a', text: 'The top ice cube is warmer than the bottom ice cube' },
            { id: 'b', text: 'The bottom ice cube is warmer than the top ice cube' },
            { id: 'c', text: 'Both ice cubes have the same temperature' },
            { id: 'd', text: 'Their temperatures fluctuate randomly' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q3',
        question: 'What happened to the ice cube held in your palm in step 1?',
        options: [
            { id: 'a', text: 'It remained unchanged' },
            { id: 'b', text: 'It began to freeze harder' },
            { id: 'c', text: 'It partially melted' },
            { id: 'd', text: 'It evaporated immediately' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q4',
        question: 'What happened to the top ice cube stacked inside the freezer in step 2?',
        options: [
            { id: 'a', text: 'It partially melted like the ice cube in step 1' },
            { id: 'b', text: 'It remained largely unchanged' },
            { id: 'c', text: 'It melted faster than the ice cube in step 1' },
            { id: 'd', text: 'It evaporated' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q5',
        question: 'Why did the ice cube in step 1 behave differently from the top ice cube in step 2?',
        options: [
            { id: 'a', text: 'The palm absorbed cold from the ice cube' },
            { id: 'b', text: 'There was a temperature difference between the palm and the ice, causing heat transfer' },
            { id: 'c', text: 'The freezer added heat to both ice cubes equally' },
            { id: 'd', text: 'Ice cubes always melt when stacked together' }
        ],
        correctAnswer: 'b'
    }
])
