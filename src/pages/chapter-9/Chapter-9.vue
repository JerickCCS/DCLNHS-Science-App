...
export default {
    ...
    setup() {
        ...
        const lessons = reactive([
            { id: 63, unitId: 3, chapterId: 9, title: "Lesson 1: Basic Concepts of Energy and Temperature", description: "Learn how energy and temperature are related and how they affect matter in everyday situations", route: "unit-3-chapter-9-lesson-1", type: "lesson", completed: false, current: true, locked: false },
            { id: 64, unitId: 3, chapterId: 9, title: "Lesson 2: Modes of Heat Transfer", description: "Understand how heat is transferred through conduction, convection, and radiation", route: "unit-3-chapter-9-lesson-2", type: "lesson", completed: false, current: false, locked: true },
            { id: 65, unitId: 3, chapterId: 9, title: "Lesson 3: Saving Energy Efficiency", description: "Explore ways energy can be conserved and used efficiently in daily life", route: "unit-3-chapter-9-lesson-3", type: "lesson", completed: false, current: false, locked: true },
            { id: 66, unitId: 3, chapterId: 9, title: "Technology in Focus", description: "Discover technologies used to measure, control, and conserve energy and heat", route: "chapter-9-technology", type: "special", completed: false, current: false, locked: true },
            { id: 67, unitId: 3, chapterId: 9, title: "Chapter Review", description: "Review key ideas about energy, temperature, and heat transfer", route: "chapter-9-review", type: "review", completed: false, current: false, locked: true },
            { id: 68, unitId: 3, chapterId: 9, title: "Activity 13: Particles in Motion", description: "Investigate how particle motion relates to temperature and energy through simple activities", route: "chapter-9-activity-13", type: "activity", completed: false, current: false, locked: true },
            { id: 69, unitId: 3, chapterId: 9, title: "Chapter Test", description: "Assess your understanding of energy, temperature, and heat transfer concepts", route: "chapter-9-test", type: "test", completed: false, current: false, locked: true },
            { id: 70, unitId: 3, chapterId: 9, title: "STEM Challenge", description: "Apply your knowledge of energy and heat to solve a real-world problem", route: "chapter-9-stem-challenge", type: "stem", completed: false, current: false, locked: true }
        ])
