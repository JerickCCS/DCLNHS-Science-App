<template>
    <div class="page-container">
        ...
        <header class="header">
            ...
            <h1 class="title">Chapter 9 Test</h1>
        </header>
...
export default {
    data() {
        const quizQuestions = [
            {
                question: "A white and a black container are filled with equal amounts of water at 20°C. Both containers are covered with the same material. If the containers are left under the sun, which scenario will happen?",
                options: [
                    "The water in the two containers will have the same temperature that is lower than 20°C",
                    "The water in the two containers will have the same temperature that is higher than 20°C",
                    "The water in the black container will have a higher temperature than the water in the white container",
                    "The water in the white container will have a higher temperature than the water in the black container"
                ],
                correctAnswer: "The water in the black container will have a higher temperature than the water in the white container",
                image: null
            },
            {
                question: "In which state(s) of matter does(do) heat convection happen?",
                options: [
                    "Gases only",
                    "Liquids only",
                ...
                correctAnswer: "Liquids and gases only",
                image: null
            },
            {
                question: "The energy from the sun reaches Earth through",
                options: [
                    "Conduction",
                    "Convection",
                    "Radiation",
            ...
            {
                question: "A moving mass of fluid transfers heat through",
                options: [
                    "Conduction",
                    "Convection",
                    "Expansion",
            ...
            {
                question: "When water is cooled in the refrigerator, what happens to the kinetic energy of the particles of water?",
                options: [
                    "Increases",
                    "Decreases",
                    "Remains unchanged",
            ...
            {
                question: "50 mL and 10 mL of water are brought to a boil. Which of the following statements is true about the setups?",
                options: [
                    "They have the same temperature",
                    "They have the same internal energy",
                    "50 mL water has higher temperature",
                    "50 mL water has higher internal energy"
                ],
                correctAnswer: "They have the same temperature",
                image: null
            },
            {
                question: "If one end of a metal knitting needle with three tiny pieces of wax placed 2 cm apart along its length is heated over the flame of a candle, which of the following will happen?",
                options: [
                    "The wax in the middle will melt first",
                    "The wax closest to the flame will melt first",
                    "The pieces of wax will melt at the same time",
                    "The wax farthest from the flame will melt first"
                ],
                correctAnswer: "The wax closest to the flame will melt first",
                image: null
            },
            {
            ...
            {
                question: "In a convection current, which of the following statements is true?",
                options: [
                    "Denser fluid rises",
                    "Denser fluid sinks",
                    "Fluids do not move",
                ...
                correctAnswer: "Denser fluid sinks",
                image: null
            }
        ];
    ...
    methods: {
        ...
        finishQuiz() {
            ...
            const chapterNumber = 9; // Chapter Number
            ...
            const lessonId = 69; // Lesson ID for this quiz
