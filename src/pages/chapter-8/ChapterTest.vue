<template>
    <div class="page-container">
        ...
        <header class="header">
            ...
            <h1 class="title">Chapter 8 Test</h1>
        </header>
...
export default {
    data() {
        const quizQuestions = [
            {
                question: "What is the corresponding position-time graph if the object moves at a constant velocity?",
                options: [
                    "A horizontal straight line",
                    "A curved line sloping upward",
                    "A straight line with positive or negative slope",
                    "A vertical straight line"
                ],
                correctAnswer: "A straight line with positive or negative slope",
                image: null
            },
            {
                question: "What is the motion of the object in this position-time graph?",
                options: [
                    "The object remains stationary",
                    "The object moves at a constant velocity",
                    "The object moves at a decreasing velocity",
                    "The object moves at an increasing velocity"
                ],
                correctAnswer: "The object moves at a constant velocity",
                image: null
            },
            {
                question: "Which of the following objects is slowing down?",
                options: [
                    "Object A: Position-time graph with constant positive slope",
                    "Object B: Position-time graph with decreasing slope",
                    "Object C: Position-time graph with increasing slope",
                    "Object D: Position-time graph with zero slope"
                ],
                correctAnswer: "Object B: Position-time graph with decreasing slope",
                image: null
            },
            {
                question: "Which of the following does not show that an object is at rest?",
                options: [
                    "The object has zero velocity",
                    "The object remains stationary",
                    "The object moves at a constant velocity",
                    "The object did not cover any displacement"
                ],
                correctAnswer: "The object moves at a constant velocity",
                image: null
            },
            {
                question: "What happens if an object slows down?",
                options: [
                ...
                correctAnswer: "Its velocity decreases",
                image: null
            },
            {
                question: "When a body moves and returns to its reference point, which of the following is zero?",
                options: [
                    "Average speed",
                    "Average velocity",
                    "Distance",
                ...
                correctAnswer: "Average velocity",
                image: null
            },
            {
                question: "As time passes, what is the velocity of the object with this position-time graph?",
                options: [
                ...
                correctAnswer: "The velocity remains the same",
                image: null
            },
            {
                question: "Which object has the greatest velocity? (Based on the position-time graph with Cars A, B, C, and D)",
                options: [
                    "Car A",
                    "Car B",
                    "Car C",
            ...
            {
                question: "Which object has the least velocity? (Based on the position-time graph with Cars A, B, C, and D)",
                options: [
                    "Car A",
                    "Car B",
                    "Car C",
            ...
            {
                question: "Which of the following situations has decreasing velocity?",
                options: [
                    "A slowing-down cart",
                    "A speeding-up race car",
                    "A yoyo moving at a constant speed in a circular path",
                    "A bowling ball rolling at a constant speed in a smooth alley"
                ],
                correctAnswer: "A slowing-down cart",
                image: null
            }
        ];
    ...
    methods: {
        ...
        finishQuiz() {
            ...
            const chapterNumber = 8; // Chapter Number
            ...
            const lessonId = 61; // Lesson ID for this quiz
