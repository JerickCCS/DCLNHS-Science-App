        ...
        <div class="content-area">
            ...
            <div v-if="activeTab === 'introduction'" class="introduction-content">
                ...
                <div class="introduction-header">
                    ...
                    <img src="assets/img/chapter 8/chapter 8.png" alt="Force" class="intro-image-wide">
                </div>

                <!-- Text above PRE-LEARNING CHECK -->
                <div class="pre-learning-intro">
                    <p>
                        Understanding motion helps explain how and why objects change position, move at different
                        speeds,
                        and travel in different directions in everyday situations.
                    </p>
                </div>
...
export default {
    ...
    setup() {
        ...
        const unitData = reactive({
            ...
            description: "Understand what motion is and how objects move by describing changes in position, distance, speed, and direction over time.",
            objectives: [
                "Define motion and describe it in terms of position and reference points",
                "Differentiate between distance and displacement using simple examples",
                "Explain how speed describes how fast an object moves",
                "Describe everyday examples of motion in terms of speed and direction"
            ],
            totalLessons: 8,
            estimatedTime: 8,
            difficulty: "Beginner"
        ...
        const lessons = reactive([
            { id: 56, unitId: 3, chapterId: 8, title: "Lesson 1: Basic Concepts of Motion", description: "Learn how motion is described using distance, speed, and direction in everyday situations", route: "unit-3-chapter-8-lesson-1", type: "lesson", completed: false, current: true, locked: false },
            { id: 57, unitId: 3, chapterId: 8, title: "Lesson 2: Uniform Motion", description: "Understand uniform motion and how constant speed affects an object’s movement over time", route: "unit-3-chapter-8-lesson-2", type: "lesson", completed: false, current: false, locked: true },
            { id: 58, unitId: 3, chapterId: 8, title: "Technology in Focus", description: "Explore tools and technologies used to measure and analyze motion", route: "chapter-8-technology", type: "special", completed: false, current: false, locked: true },
            { id: 59, unitId: 3, chapterId: 8, title: "Chapter Review", description: "Review key concepts about motion and uniform motion", route: "chapter-8-review", type: "review", completed: false, current: false, locked: true },
            { id: 60, unitId: 3, chapterId: 8, title: "Activity 12: Factors Affecting Motion in Toy Cars", description: "Investigate how different factors affect the motion of toy cars through simple experiments", route: "chapter-8-activity-12", type: "activity", completed: false, current: false, locked: true },
            { id: 61, unitId: 3, chapterId: 8, title: "Chapter Test", description: "Assess your understanding of motion and uniform motion concepts", route: "chapter-8-test", type: "test", completed: false, current: false, locked: true },
            { id: 62, unitId: 3, chapterId: 8, title: "STEM Challenge", description: "Apply your understanding of motion to solve a real-world problem", route: "chapter-8-stem-challenge", type: "stem", completed: false, current: false, locked: true }
        ])
