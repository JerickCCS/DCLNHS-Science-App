...
export default {
    ...
    setup() {
        ...
        const lessonId = lesson ? String(lesson.id) : "62"
    ...
    <div>
      ...
      <div class="header">
        <div class="title">Motion Map</div>
      </div>
      <p>The Philippines is considered one of the best vacation sites in the world. Palawan, Cebu, and Bohol are among the top destinations that local and foreign tourists frequently visit or dream of visiting. With more than 7000 islands of the Philippines, there are still a lot of hidden vacation spots to be explored across the country.</p>
      <p>Summer is fast approaching, and some tourists want to move away from crowded tourist attractions and explore beautiful, but not so popular, places instead.</p>
    </div>
    `,
            `
    <div>
      <!-- Card 2 -->
      <p>Help them plan their trip by preparing a map that shows at least five tourist spots near your town. Use your knowledge of the different quantities of motion—distance, displacement, speed, and velocity—for the tourists to have a smooth travel itinerary.</p>
    </div>
    `
        ]
