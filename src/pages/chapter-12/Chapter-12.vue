...
export default {
    ...
    setup() {
        ...
        const lessons = reactive([
            { id: 87, unitId: 4, chapterId: 12, title: "Lesson 1: Earth's Motions", description: "Understand Earth's rotation and revolution and their effects", route: "unit-4-chapter-12-lesson-1", type: "lesson", completed: false, current: true, locked: false },
            { id: 88, unitId: 4, chapterId: 12, title: "Lesson 2: Seasons in the Philippines", description: "Learn how Earth's tilt and motion create seasons in the Philippines", route: "unit-4-chapter-12-lesson-2", type: "lesson", completed: false, current: false, locked: true },
            { id: 89, unitId: 4, chapterId: 12, title: "Technology in Focus", description: "Discover technologies used to study Earth's motions and seasons", route: "chapter-12-technology", type: "special", completed: false, current: false, locked: true },
            { id: 90, unitId: 4, chapterId: 12, title: "Chapter Review", description: "Review key concepts about Earth's motions and seasons", route: "chapter-12-review", type: "review", completed: false, current: false, locked: true },
            { id: 91, unitId: 4, chapterId: 12, title: "Activity 17: Earth's Seasons", description: "Explore why Earth experiences different seasons", route: "chapter-12-activity-17", type: "activity", completed: false, current: false, locked: true },
            { id: 92, unitId: 4, chapterId: 12, title: "Chapter Test", description: "Evaluate your understanding of Earth's motions and seasons", route: "chapter-12-test", type: "test", completed: false, current: false, locked: true }
        ])
