...
const questions = ref([
    {
        id: 'q1',
        question: 'Why does the Philippines have only two seasons instead of four?',
        options: [
            { id: 'a', text: 'The Philippines is near the equator and receives almost the same amount of sunlight year-round, with seasons influenced by monsoons' },
            { id: 'b', text: 'The Philippines is too small to have four distinct seasons like larger countries' },
            { id: 'c', text: 'The government officially declared only two seasons for agricultural purposes' },
            { id: 'd', text: 'The four-season cycle doesn\'t apply to islands and archipelagos' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q2',
        question: 'How do temperature, humidity, and rainfall affect the seasons in the Philippines?',
        options: [
            { id: 'a', text: 'Temperature ranges from 25.56°C to 29.44°C, humidity is high due to surrounding waters, and rainfall patterns define wet/dry seasons through monsoon winds' },
            { id: 'b', text: 'Temperature is constant year-round, humidity only affects coastal areas, and rainfall has no seasonal pattern' },
            { id: 'c', text: 'Temperature determines everything while humidity and rainfall are insignificant factors in Philippine seasons' },
            { id: 'd', text: 'Only rainfall matters for seasons; temperature and humidity remain the same throughout the year' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q3',
        question: 'Which of the following correctly describes the advantages and disadvantages of dry and wet seasons?',
        options: [
            { id: 'a', text: 'Dry: Good for outdoor activities but risk of drought. Wet: Provides irrigation but risk of flooding and diseases' },
            { id: 'b', text: 'Dry season has no disadvantages, wet season has no advantages' },
            { id: 'c', text: 'Both seasons are equally perfect for all activities with no drawbacks' },
            { id: 'd', text: 'Dry season causes constant flooding, wet season prevents all crop growth' }
        ],
        correctAnswer: 'a'
    }
])
