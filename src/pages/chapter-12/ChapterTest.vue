<template>
    <div class="page-container">
        ...
        <header class="header">
            ...
            <h1 class="title">Chapter 12 Test</h1>
        </header>
...
export default {
    data() {
        const quizQuestions = [
            ...
            },
            {
                ...
                correctAnswer: "Earth's tilt as it revolves around the sun",
                image: null
            },
            {
                question: "During which phenomenon does the Northern Hemisphere experience the longest daytime?",
                options: [
                    "Winter solstice",
                    "Vernal equinox",
                    "Summer solstice",
            ...
            {
                question: "What is observed in the amount of sunlight in the Philippines?",
                options: [
                    "The amount of sunlight received by the region varies only twice every year",
                    "The amount of sunlight received by the region is equal to that of the polar caps",
                    "The sunlight hits the region more directly than in any other parts of the Earth",
                    "The amount of sunlight received by the region is almost the same throughout the year"
                ],
                correctAnswer: "The amount of sunlight received by the region is almost the same throughout the year",
                image: null
            },
            {
                question: "What season is experienced in the Northern Hemisphere when it is summer in the Southern Hemisphere?",
                options: [
                    "Fall",
                    "Spring",
                    "Winter",
            ...
            {
                question: "Why is daytime longer during summer in the Northern Hemisphere?",
                options: [
                    "The sun is closer to Earth",
                    "The North Pole is tilted towards the sun",
                    "Sunlight falls directly on the Southern Hemisphere",
                    "A smaller portion of the Southern Hemisphere receives sunlight"
                ],
                correctAnswer: "The North Pole is tilted towards the sun",
                image: null
            },
            {
                question: "Why are places near the equator generally hotter than those on the higher latitudes?",
                options: [
                    "Because the region always faces the sun",
                    "Because the region has a thinner atmosphere",
                    "Because the region is always closer to the sun",
                    "Because the region receives more direct sunlight throughout most of the year"
                ],
                correctAnswer: "Because the region receives more direct sunlight throughout most of the year",
                image: null
            },
            {
                question: "Which of the following is true about equinoxes?",
                options: [
                    "Daytime becomes longer than nighttime",
                    "Nighttime becomes longer than nighttime",
                    "Both daytime and nighttime are of equal length",
                    "The Earth's tilt reduces to 0°, making the hemispheres experience the same season"
                ],
                correctAnswer: "Both daytime and nighttime are of equal length",
                image: null
            },
            {
                question: "To determine the number of daylight hours in Manila, you started recording the times of sunrise and sunset every day. You observed that from March to May, the number of daylight hours was getting longer. Manila is in the Northern Hemisphere. Why are days getting longer in Manila during this time?",
                options: [
                    "The sun moves faster across the sky",
                    "Daylight is extended in the Philippines",
                    "The Southern Hemisphere is tilted toward the sun",
                    "A larger part of the Northern Hemisphere is receiving sunlight"
                ],
                correctAnswer: "A larger part of the Northern Hemisphere is receiving sunlight",
                image: null
            },
            {
                question: "Which of the following is not true about the Polar Regions?",
                options: [
                    "During polar winter, the sun never rises",
                    "During polar summer, the sun never sets",
                    "Polar Regions experience the four seasons throughout the year",
                    "Polar Regions receive the least amount of sunlight throughout the year"
                ],
                correctAnswer: "Polar Regions experience the four seasons throughout the year",
                image: null
            },
            {
                question: "Which shows summer in the Northern Hemisphere? (Based on figures showing where direct sunlight strikes Earth)",
                options: [
                    "Figure I only",
                    "Figure II only",
                    "Figure III only",
    ...
    methods: {
        ...
        finishQuiz() {
            ...
            const chapterNumber = 12; // Chapter Number
            ...
            const lessonId = 92; // Lesson ID for this quiz
