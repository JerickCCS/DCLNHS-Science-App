    ...
    <q-page class="chapter-page">
        ...
        <q-header class="chapter-header no-shadow">
            <q-toolbar class="chapter-toolbar">
                ...
                <div class="toolbar-title">Chapter 11</div>
            </q-toolbar>
            ...
            <transition :name="tabTransitionName" mode="out-in">
                ...
                <div v-if="activeTab === 'introduction'" key="introduction" class="introduction-content">
                    ...
                    <div class="hero-banner">
                        <img src="assets/img/chapter 11/chapter 11.png" alt="Interactions in the Atmosphere"
                            class="hero-image" />
                        <div class="hero-overlay">
                            <span class="hero-eyebrow">Chapter 11</span>
                            <h1 class="hero-title">Interactions in the Atmosphere</h1>
                        </div>
                    </div>
                    ...
                    <div class="quote-card">
                        ...
                        <p class="quote-text">The atmosphere is not just the air we breathe — it is the engine that
                            drives our weather and climate.</p>
                        <p class="quote-author">— Philippine Atmospheric, Geophysical and Astronomical Services
                            Administration</p>
                    </div>

                    <!-- Body text -->
                    <div class="body-card">
                        <p>Our country is constantly visited by tropical cyclones. In recent years, tropical cyclones
                            such
                            as Tropical Storm Ondoy and Super Typhoon Yolanda have claimed countless lives and have had
                            long-lasting impact on the lives of many people. In order to mitigate the negative effects
                            of
                            tropical cyclones, it is important to understand tropical cyclones, as well as other
                            atmospheric
                            phenomena, and how they can affect our lives.</p>
                        <p>In this chapter, you will understand what causes weather and weather-related phenomena in the
                            Philippines.</p>
                    </div>
                    ...
                    <div class="lessons-banner">
                        ...
                        <div class="lessons-banner-content">
                            <div class="lessons-banner-text">
                                <span class="lessons-banner-eyebrow">Chapter 11 · Interactions in the Atmosphere</span>
...
export default {
    ...
    setup() {
        ...
        const lessons = reactive([
            { id: 79, title: "Lesson 1: The Earth's Atmosphere", label: "Lesson 1", description: "Learn about the layers and composition of Earth's atmosphere.", route: "unit-4-chapter-11-lesson-1", completed: false, current: true, locked: false },
            { id: 80, title: "Lesson 2: Movement in the Atmosphere", label: "Lesson 2", description: "Understand how air moves and what causes wind patterns.", route: "unit-4-chapter-11-lesson-2", completed: false, current: false, locked: true },
            { id: 81, title: "Technology in Focus", label: null, description: "Explore technologies used to study the atmosphere.", route: "chapter-11-technology", completed: false, current: false, locked: true },
            { id: 82, title: "Chapter Review", label: null, description: "Review key concepts about Earth's atmosphere.", route: "chapter-11-review", completed: false, current: false, locked: true },
            { id: 83, title: "Activity 15: Uneven Heating of Earth's Surface", label: null, description: "Investigate how uneven heating affects atmospheric movement.", route: "chapter-11-activity-15", completed: false, current: false, locked: true },
            { id: 84, title: "Activity 16: Amount of Water Vapor in the Air", label: null, description: "Measure and analyze water vapor in the atmosphere.", route: "chapter-11-activity-16", completed: false, current: false, locked: true },
            { id: 85, title: "Chapter Test", label: null, description: "Assess your understanding of the atmosphere.", route: "chapter-11-test", completed: false, current: false, locked: true },
            { id: 86, title: "STEM Challenge", label: null, description: "Apply atmospheric concepts in a real-world STEM challenge.", route: "chapter-11-stem", completed: false, current: false, locked: true }
        ])
