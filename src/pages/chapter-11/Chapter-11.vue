...
export default {
    ...
    setup() {
        ...
        const lessons = reactive([
            { id: 79, unitId: 4, chapterId: 11, title: "Lesson 1: The Earth's Atmosphere", description: "Learn about the layers and composition of Earth's atmosphere", route: "unit-4-chapter-11-lesson-1", type: "lesson", completed: false, current: true, locked: false },
            { id: 80, unitId: 4, chapterId: 11, title: "Lesson 2: Movement in the Atmosphere", description: "Understand how air moves and what causes wind patterns", route: "unit-4-chapter-11-lesson-2", type: "lesson", completed: false, current: false, locked: true },
            { id: 81, unitId: 4, chapterId: 11, title: "Technology in Focus", description: "Explore technologies used to study the atmosphere", route: "chapter-11-technology", type: "special", completed: false, current: false, locked: true },
            { id: 82, unitId: 4, chapterId: 11, title: "Chapter Review", description: "Review key concepts about Earth’s atmosphere", route: "chapter-11-review", type: "review", completed: false, current: false, locked: true },
            { id: 83, unitId: 4, chapterId: 11, title: "Activity 15: Uneven Heating of Earth's Surface", description: "Investigate how uneven heating affects atmospheric movement", route: "chapter-11-activity-15", type: "activity", completed: false, current: false, locked: true },
            { id: 84, unitId: 4, chapterId: 11, title: "Activity 16: Amount of Water Vapor in the Air", description: "Measure and analyze water vapor in the atmosphere", route: "chapter-11-activity-16", type: "activity", completed: false, current: false, locked: true },
            { id: 85, unitId: 4, chapterId: 11, title: "Chapter Test", description: "Assess your understanding of the atmosphere", route: "chapter-11-test", type: "test", completed: false, current: false, locked: true },
            { id: 86, unitId: 4, chapterId: 11, title: "STEM Challenge", description: "Apply atmospheric concepts in a real-world STEM challenge", route: "chapter-11-stem", type: "stem", completed: false, current: false, locked: true }
        ])
