<template>
    <div class="page-container">
        ...
        <header class="header">
            ...
            <h1 class="title">Chapter 11 Test</h1>
        </header>
...
export default {
    data() {
        const quizQuestions = [
            {
                question: "Why does warm air rise and cold air sink?",
                options: [
                    "Warm air is less dense than cold air",
                    "Warm air has less mass than cold air",
                    "Warm air exerts less pressure than cold air",
                    "Warm air molecules have lower average kinetic energy"
                ],
                correctAnswer: "Warm air is less dense than cold air",
                image: null
            },
            {
                question: "What is the relationship between temperature and altitude in the mesosphere?",
                options: [
                    "The temperature increases as the altitude increases",
                    "The temperature decreases as the altitude decreases",
                    "The temperature decreases as the altitude increases",
                    "The temperature increases as the altitude decreases"
                ],
                correctAnswer: "The temperature decreases as the altitude increases",
                image: null
            },
            {
                question: "Which statement is not true about water vapor in the atmosphere?",
                options: [
                    "Water vapor regulates air temperature",
                    "Without water vapor, rainfall is not possible",
                    "Water vapor is present in all layers of the atmosphere",
                    "Water vapor is an important component of the atmosphere"
                ],
                correctAnswer: "Water vapor is present in all layers of the atmosphere",
                image: null
            },
            {
                question: "Which of the following is incorrect about monsoons?",
                options: [
                    "Monsoons begin during the winter months",
                    "Three monsoons affect the weather in the Philippines",
                    "Monsoons are winds that change direction as the seasons change",
                    "The cold, dry air in the Himalayas flows toward the warm, low-pressure area over India"
                ],
                correctAnswer: "Three monsoons affect the weather in the Philippines",
                image: null
            },
            {
                question: "Which pie chart represents the composition of the atmosphere?",
                options: [
                    "Chart A: 78% Nitrogen, 21% Oxygen, 1% Other gases",
                    "Chart B: 21% Nitrogen, 78% Oxygen, 1% Other gases",
                    "Chart C: 50% Nitrogen, 50% Oxygen",
                    "Chart D: 65% Nitrogen, 25% Oxygen, 10% Other gases"
                ],
                correctAnswer: "Chart A: 78% Nitrogen, 21% Oxygen, 1% Other gases",
                image: null
            },
            {
                question: "Why is land breeze observed at night?",
                options: [
                    "The flow of air is not hindered",
                    "Air over the land cools easily at night",
                    "Air over the land warms easily at night",
                    "There is much water vapor over the land"
                ],
                correctAnswer: "Air over the land cools easily at night",
                image: null
            },
            {
                question: "Due to uneven heating, liquids and gases move in a circular motion. What is this process called?",
                options: [
                    "Conduction",
                    "Convection",
                    "Insolation",
            ...
            {
                question: "Why is the troposphere called the weather sphere?",
                options: [
                    "The troposphere has water vapor",
                    "The temperature decreases as the altitude increases",
                    "There is a high concentration of ozone in this layer",
                    "Temperature increases as altitude decreases in the troposphere"
                ],
                correctAnswer: "The troposphere has water vapor",
                image: null
            },
            {
                question: "What will happen to a cold air mass when it comes in contact with the warm surface of Earth?",
                options: [
                    "It will get colder",
                ...
                correctAnswer: "It will become warmer",
                image: null
            },
            {
                question: "What will happen to the air just above the ground that becomes warmer?",
                options: [
                    "It will rise",
                    "It will sink",
                    "Its density will increase",
                    "Its particles will move closer to one another"
                ],
                correctAnswer: "It will rise",
                image: null
            }
        ];
    ...
    methods: {
        ...
        finishQuiz() {
            ...
            const chapterNumber = 11; // Chapter Number
            ...
            const lessonId = 85; // Lesson ID for this quiz
