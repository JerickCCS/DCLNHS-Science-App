...
const questions = ref([
    {
        id: 'q1',
        question: 'What causes land breeze and sea breeze to form?',
        options: [
            { id: 'a', text: 'Differences in temperature between land and water' },
            { id: 'b', text: 'Rotation of the Earth' },
            { id: 'c', text: 'Ocean currents moving water around' },
            { id: 'd', text: 'Mountain ranges blocking wind' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q2',
        question: 'If A is a high-pressure area and B is a low-pressure area, where does the air move?',
        image: '/assets/img/chapter 1/analytical balance.png', // Add image reference here
        options: [
            { id: 'a', text: 'From A to B (high to low pressure)' },
            { id: 'b', text: 'From B to A (low to high pressure)' },
            { id: 'c', text: 'Air doesn\'t move between them' },
            { id: 'd', text: 'Air moves in circles around them' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q3',
        question: 'What causes monsoons to form?',
        options: [
            { id: 'a', text: 'Seasonal reversal of wind patterns due to temperature differences' },
            { id: 'b', text: 'Random weather patterns' },
            { id: 'c', text: 'Ocean pollution creating rain' },
            { id: 'd', text: 'Volcanic eruptions changing air pressure' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q4',
        question: 'Which statement best shows the similarities and differences between the Northeast Monsoon and the Southwest Monsoon?',
        options: [
            { id: 'a', text: 'Both are seasonal winds but bring rain from different directions' },
            { id: 'b', text: 'Both occur only in tropical regions and bring same amount of rain' },
            { id: 'c', text: 'Both are caused by ocean currents, not temperature differences' },
            { id: 'd', text: 'Both occur year-round without seasonal changes' }
        ],
        correctAnswer: 'a'
    }
])
