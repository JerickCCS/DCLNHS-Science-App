...
const questions = ref([
    {
        id: 'q1',
        question: 'What are the five main layers of the Earth\'s atmosphere?',
        options: [
            { id: 'a', text: 'Troposphere, Stratosphere, Mesosphere, Thermosphere, Exosphere' },
            { id: 'b', text: 'Ground, Sky, Clouds, Space, Beyond' },
            { id: 'c', text: 'Inner, Outer, Middle, Upper, Lower' },
            { id: 'd', text: 'Air, Wind, Weather, Climate, Space' }
        ],
        correctAnswer: 'a'
    },
    {
        ...
        options: [
            { id: 'a', text: 'It provides oxygen to breathe and protects from the Sun\'s harmful rays' },
            { id: 'b', text: 'It makes the sky look blue' },
            { id: 'c', text: 'It causes wind and rain only' },
            { id: 'd', text: 'It helps airplanes fly' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q3',
        question: 'How does temperature change in the troposphere (the layer where we live)?',
        options: [
            { id: 'a', text: 'Temperature gets colder as you go higher' },
            { id: 'b', text: 'Temperature gets warmer as you go higher' },
            { id: 'c', text: 'Temperature stays the same at all heights' },
            { id: 'd', text: 'Temperature changes randomly' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q4',
        question: 'Which layer of the atmosphere has the hottest temperatures?',
        options: [
            { id: 'a', text: 'Thermosphere - because it absorbs solar energy directly' },
            { id: 'b', text: 'Troposphere - because it\'s closest to the ground' },
            { id: 'c', text: 'Mesosphere - because it\'s in the middle' },
            { id: 'd', text: 'Stratosphere - because it has the ozone layer' }
        ],
        correctAnswer: 'a'
    }
])
