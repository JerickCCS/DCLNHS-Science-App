            ...
            <q-page class="q-pa-md">
                ...
                <div class="paragraph-container q-mt-lg">
                    <div class="text-subtitle2 text-weight-bold q-mb-md">
                        Complete the cell paragraph:
                    </div>

                    <div class="safety-paragraph">
                        <p>
                            A cell has several important parts. The
                            <span class="blank" @dragover.prevent @dragenter.prevent
                                @drop="dropWord($event, 'cellWall')">
                                {{ blanks.cellWall || '________' }}
                            </span> is the outermost layer that gives the cell its shape and provides protection. Just
                            inside it is the
                            <span class="blank" @dragover.prevent @dragenter.prevent
                                @drop="dropWord($event, 'cellMembrane')">
                                {{ blanks.cellMembrane || '________' }}
                            </span>, which controls what substances enter and exit the cell.
                        </p>

                        <p>
                            Filling most of the inside of the cell is the
                            <span class="blank" @dragover.prevent @dragenter.prevent
                                @drop="dropWord($event, 'cytoplasm')">
                                {{ blanks.cytoplasm || '________' }}
                            </span>, a jelly-like fluid that holds all the cell parts together. At the center is the
                            <span class="blank" @dragover.prevent @dragenter.prevent
                                @drop="dropWord($event, 'nucleus')">
                                {{ blanks.nucleus || '________' }}
                            </span>, which acts as the control center and directs all cell activities.
                            The part that occupies most of the space inside the cell is the
                            <span class="blank" @dragover.prevent @dragenter.prevent
                                @drop="dropWord($event, 'cytoplasmAnswer')">
                                {{ blanks.cytoplasmAnswer || '________' }}
                            </span>.
                        </p>
                    </div>
                </div>
...
const initialKeywords = [
    { text: 'cell wall', correctFor: 'cellWall', used: false },
    { text: 'cell membrane', correctFor: 'cellMembrane', used: false },
    { text: 'cytoplasm', correctFor: 'cytoplasm', used: false },
    { text: 'nucleus', correctFor: 'nucleus', used: false },
    { text: 'cytoplasm', correctFor: 'cytoplasmAnswer', used: false }
]
