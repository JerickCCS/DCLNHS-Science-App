...
const questions = ref([
    {
        id: 'q1',
        question: 'Just like workers in a school have different jobs (teachers teach, janitors clean, guards protect), what do the parts of the cell do?',
        options: [
            { id: 'a', text: 'They all do the same job together' },
            { id: 'b', text: 'Each part has its own special job to keep the cell alive' },
            { id: 'c', text: 'Only the nucleus does all the work' },
            { id: 'd', text: 'The parts do not need to work at all' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q2',
        question: 'The nucleus is like the "boss" of the cell. What is the main job of the nucleus?',
        options: [
            { id: 'a', text: 'To give energy to the cell' },
            { id: 'b', text: 'To protect the cell from the outside' },
            { id: 'c', text: 'To control and direct all the activities happening inside the cell' },
            { id: 'd', text: 'To store food and water for the cell' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q3',
        question: 'The mitochondria is known as the "powerhouse of the cell." Why is it important for the cell to have mitochondria?',
        options: [
            { id: 'a', text: 'It gives the cell its shape' },
            { id: 'b', text: 'It produces energy the cell needs to do its work' },
            { id: 'c', text: 'It cleans up waste inside the cell' },
            { id: 'd', text: 'It sends messages between cells' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q4',
        question: 'Making a protein in the cell is like a relay race — ribosomes make it, then the Golgi body packages it. What does this tell us about how organelles work?',
        options: [
            { id: 'a', text: 'Organelles work against each other' },
            { id: 'b', text: 'Only one organelle is needed to get things done' },
            { id: 'c', text: 'Organelles take turns and help each other to finish a job' },
            { id: 'd', text: 'Organelles do not need to communicate with each other' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q5',
        question: 'If the lysosomes stop cleaning up waste and the mitochondria stops making energy, what will most likely happen to the cell?',
        options: [
            { id: 'a', text: 'The cell will work even better without them' },
            { id: 'b', text: 'Nothing will change because other parts will take over' },
            { id: 'c', text: 'The cell will struggle or die because its parts depend on each other' },
            { id: 'd', text: 'Only the nucleus will be affected' }
        ],
        correctAnswer: 'c'
    }
])
