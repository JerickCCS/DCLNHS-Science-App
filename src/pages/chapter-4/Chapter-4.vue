...
export default {
    ...
    setup() {
        ...
        const lessons = reactive([
            { id: 28, title: "Lesson 1: The Microscope: Parts and Function", description: "Identify the parts of a microscope and their functions", route: "unit-2-chapter-4-lesson-1", completed: false, current: true, locked: false },
            { id: 29, title: "Lesson 2: The Cell: The Basic Unit of Life", description: "Understand the cell as the basic unit of life", route: "unit-2-chapter-4-lesson-2", completed: false, current: false, locked: true },
            { id: 30, title: "Technology in Focus", description: "Explore technology used in microscopy and cell studies", route: "unit-2-chapter-4-technology", completed: false, current: false, locked: true },
            { id: 31, title: "Chapter Review", description: "Review key concepts about microscopes and cells", route: "unit-2-chapter-4-review", completed: false, current: false, locked: true },
            { id: 32, title: "Activity 6: Parts of a Compound Microscope", description: "Hands-on activity identifying microscope parts", route: "unit-2-chapter-4-activity-6", completed: false, current: false, locked: true },
            { id: 33, title: "Activity 7: Focusing Specimens under the Compound Microscope", description: "Practice focusing specimens using a compound microscope", route: "unit-2-chapter-4-activity-7", completed: false, current: false, locked: true },
            { id: 34, title: "Chapter Test", description: "Assess understanding of microscopes and cells", route: "unit-2-chapter-4-test", completed: false, current: false, locked: true },
            { id: 35, title: "STEM Challenge", description: "Apply learning through a STEM-based challenge", route: "unit-2-chapter-4-stem-challenge", completed: false, current: false, locked: true }
        ])
