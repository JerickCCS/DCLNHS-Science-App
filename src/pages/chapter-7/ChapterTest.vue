<template>
    <div class="page-container">
        ...
        <header class="header">
            ...
            <h1 class="title">Chapter 7 Test</h1>
        </header>
...
export default {
    data() {
        const quizQuestions = [
            {
                question: "As a parachute descends, which force gradually increases until it balances the force of gravity?",
                options: [
                    "Air resistance",
                    "Buoyant force",
                    "Normal force",
            ...
            {
                question: "In most vehicles, a hydraulic system employs brake fluid to transfer the force from the brake pedal to the wheel brakes. In addition to the applied force, which force is manifested in this scenario?",
                options: [
                    "Buoyant force",
                    "Force of gravity",
                    "Friction force",
            ...
            {
                question: "Which force is present in the shock absorbers and car suspensions of vehicles, and is responsible for absorbing shocks and vibrations for a smoother ride?",
                options: [
                    "Buoyant force",
                    "Force of gravity",
                    "Force of friction",
            ...
            {
                question: "Which of the following scenarios does not belong to the group?",
                options: [
                    "Bending a straw",
                ...
                correctAnswer: "Sliding down a slide",
                image: null
            },
            {
                question: "When the net force acting on a moving object is zero, the object",
                options: [
                    "Moves in constant direction",
                    "Moves at constant speed",
                    "Moves at varying speed",
                    "Moves with constant speed and direction"
                ],
                correctAnswer: "Moves with constant speed and direction",
                image: null
            },
            {
                question: "What is the orientation of the force of gravity?",
                options: [
                    "Always directed upward",
                    "Always directed downward",
                    "Always parallel to the normal force",
                    "Always perpendicular to the surface"
                ],
                correctAnswer: "Always directed downward",
                image: null
            },
            {
                question: "A calibrated spring balance is used to measure the force. As the object is attached to the hook, the spring elongates. The amount of elongation in the calibrated spring corresponds to the specific force value. What is the force reading on the spring scale?",
                options: [
                    "10 N",
                    "20 N",
                    "30 N",
            ...
            {
                question: "Which is the appropriate free-body diagram of a block sliding along an inclined plane? (Note: The x-axis represents the inclined plane)",
                options: [
                    "Diagram A (Force vectors: weight straight down, normal perpendicular to surface, friction opposite motion)",
                    "Diagram B (Force vectors: weight at angle, normal upward, friction parallel)",
                    "Diagram C (Force vectors: all forces parallel to surface)",
                    "Diagram D (Force vectors: weight only, no other forces)"
                ],
                correctAnswer: "Diagram A (Force vectors: weight straight down, normal perpendicular to surface, friction opposite motion)",
                image: null
            },
            {
                question: "When dealing with two or more forces acting on a body, what is the most effective method to determine the net force?",
                options: [
                    "Create a free-body diagram",
                    "Identify all forces acting on the body",
                    "Calculate the sum of forces separately along the x- and y-axes",
                    "All of the above"
                ],
            ...
            {
                question: "When you lift a load using a pulley, which of the following forces is not present?",
                options: [
                    "Applied force",
                    "Force of gravity",
                    "Spring force",
    ...
    methods: {
        ...
        finishQuiz() {
            ...
            const chapterNumber = 7; // Chapter Number
            ...
            const lessonId = 55; // Lesson ID for this quiz
