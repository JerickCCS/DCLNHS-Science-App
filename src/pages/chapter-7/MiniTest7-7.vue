...
const questions = ref([
    {
        id: 'q1',
        question: 'Determine whether the following situation involves balanced (B) or unbalanced (UB) forces: Tossing a coin',
        options: [
            { id: 'a', text: 'Balanced (B)' },
            { id: 'b', text: 'Unbalanced (UB)' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q2',
        question: 'Determine whether the following situation involves balanced (B) or unbalanced (UB) forces: Sitting on a chair',
        options: [
            { id: 'a', text: 'Balanced (B)' },
            { id: 'b', text: 'Unbalanced (UB)' }
        ],
    ...
    {
        id: 'q3',
        question: 'Determine whether the following situation involves balanced (B) or unbalanced (UB) forces: Throwing a ball',
        options: [
            { id: 'a', text: 'Balanced (B)' },
            { id: 'b', text: 'Unbalanced (UB)' }
        ],
    ...
    {
        id: 'q4',
        question: 'Determine whether the following situation involves balanced (B) or unbalanced (UB) forces: A falling stone',
        options: [
            { id: 'a', text: 'Balanced (B)' },
            { id: 'b', text: 'Unbalanced (UB)' }
        ],
    ...
    {
        id: 'q5',
        question: 'Determine whether the following situation involves balanced (B) or unbalanced (UB) forces: Hanging a mobile sculpture',
        options: [
            { id: 'a', text: 'Balanced (B)' },
            { id: 'b', text: 'Unbalanced (UB)' }
        ],
    ...
    {
        id: 'q6',
        question: 'Determine whether the following situation involves balanced (B) or unbalanced (UB) forces: A car moving at a constant speed',
        options: [
            { id: 'a', text: 'Balanced (B)' },
            { id: 'b', text: 'Unbalanced (UB)' }
        ],
    ...
    {
        id: 'q7',
        question: 'Determine whether the following situation involves balanced (B) or unbalanced (UB) forces: The stable structure of a building',
        options: [
            { id: 'a', text: 'Balanced (B)' },
            { id: 'b', text: 'Unbalanced (UB)' }
        ],
    ...
    {
        id: 'q8',
        question: 'Determine whether the following situation involves balanced (B) or unbalanced (UB) forces: A kid sliding on a pool slide',
        options: [
            { id: 'a', text: 'Balanced (B)' },
            { id: 'b', text: 'Unbalanced (UB)' }
        ],
    ...
    {
        id: 'q9',
        question: 'Determine whether the following situation involves balanced (B) or unbalanced (UB) forces: Swinging a hammer to drive a nail',
        options: [
            { id: 'a', text: 'Balanced (B)' },
            { id: 'b', text: 'Unbalanced (UB)' }
        ],
    ...
    {
        id: 'q10',
        question: 'Determine whether the following situation involves balanced (B) or unbalanced (UB) forces: A box on top of a table',
        options: [
            { id: 'a', text: 'Balanced (B)' },
            { id: 'b', text: 'Unbalanced (UB)' }
        ],
