...
const questions = ref([
    {
        id: 'q1',
        question: 'What is the effect of applying force on the brake lever?',
        image: 'assets/img/chapter 7/1.png',
        options: [
            { id: 'a', text: 'The bicycle speeds up' },
            { id: 'b', text: 'The bicycle changes color' },
            { id: 'c', text: 'The bicycle slows down or stops' },
            { id: 'd', text: 'The bicycle becomes heavier' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q2',
        question: 'What happens when you push a shopping cart?',
        image: 'assets/img/chapter 7/2.png',
        options: [
            { id: 'a', text: 'It moves forward' },
            { id: 'b', text: 'It becomes smaller' },
            { id: 'c', text: 'It disappears' },
            { id: 'd', text: 'It changes direction randomly' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q3',
        question: 'What is the effect of applying force to clay while molding?',
        image: 'assets/img/chapter 7/3.png',
        options: [
            { id: 'a', text: 'The clay becomes harder' },
            { id: 'b', text: 'The clay disappears' },
            { id: 'c', text: 'The clay changes color' },
            { id: 'd', text: 'The clay changes shape' }
        ],
        correctAnswer: 'd'
    },
    {
        id: 'q4',
        question: 'What happens when you hit a ping-pong ball?',
        image: 'assets/img/chapter 7/4.png',
        options: [
            { id: 'a', text: 'It breaks immediately' },
            { id: 'b', text: 'It becomes heavier' },
            { id: 'c', text: 'It stays still' },
            { id: 'd', text: 'It changes direction and speed' }
        ],
        correctAnswer: 'd'
    },
    {
        id: 'q5',
        question: 'What is the effect of applying force when throwing a javelin?',
        image: 'assets/img/chapter 7/5.png',
        options: [
            { id: 'a', text: 'It stays in your hand' },
            { id: 'b', text: 'It melts' },
            { id: 'c', text: 'It becomes invisible' },
            { id: 'd', text: 'It moves through the air' }
        ],
        correctAnswer: 'd'
    }
])
