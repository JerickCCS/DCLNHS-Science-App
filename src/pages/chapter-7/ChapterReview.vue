...
export default {
    ...
    setup() {
        ...
        const lessonId = lesson ? String(lesson.id) : "53"
    ...
    <div>
      ...
      <p>• A force is a push or a pull that can change the motion of an object or change its shape.</p>
      <p>• If the net force is zero, balanced forces are acting on an object. The object can remain stationary or move at constant speed in a constant direction.</p>
      <p>• If the net force is not zero, unbalanced forces are acting on an object. The object tends to move or change its speed and/or direction.</p>
    </div>
    `
        ])
