...
const questions = ref([
    {
        id: 'q1',
        question: 'Which forces act on a floating stationary ball in water?',
        image: 'assets/img/chapter 7/7-6 a.png',
        options: [
            { id: 'a', text: 'Buoyant force and gravitational force' },
            { id: 'b', text: 'Friction and tension' },
            { id: 'c', text: 'Applied force only' },
            { id: 'd', text: 'Magnetic force and normal force' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q2',
        question: 'Which forces act on a kid playing on a frictionless slide?',
        image: 'assets/img/chapter 7/7-6 b.png',
        options: [
            { id: 'a', text: 'Friction and tension' },
            { id: 'b', text: 'Gravitational force and normal force' },
            { id: 'c', text: 'Buoyant force and drag force' },
            { id: 'd', text: 'Applied force only' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q3',
        question: 'Which forces act when a man is lifting a load using a pulley?',
        image: 'assets/img/chapter 7/7-6 c.png',
        options: [
            { id: 'a', text: 'Magnetic force and friction' },
            { id: 'b', text: 'Gravitational force only' },
            { id: 'c', text: 'Tension force and gravitational force' },
            { id: 'd', text: 'Normal force only' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q4',
        question: 'Which forces act on a crate being pushed up an inclined plane?',
        image: 'assets/img/chapter 7/7-6 d.png',
        options: [
            { id: 'a', text: 'Applied force, gravitational force, normal force, and friction' },
            { id: 'b', text: 'Buoyant force and drag force' },
            { id: 'c', text: 'Tension force only' },
            { id: 'd', text: 'Magnetic force and applied force' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q5',
        question: 'Which forces act on a man descending with a parachute?',
        image: 'assets/img/chapter 7/7-6 e.png',
        options: [
            { id: 'a', text: 'Normal force and friction' },
            { id: 'b', text: 'Applied force only' },
            { id: 'c', text: 'Gravitational force and air resistance (drag)' },
            { id: 'd', text: 'Tension force and magnetic force' }
        ],
        correctAnswer: 'c'
    }
])
