...
const questions = ref([
    {
        id: 'q1',
        question: 'Which forces act on a swinging pendulum?',
        image: 'assets/img/chapter 7/6.png',
        options: [
            { id: 'a', text: 'Magnetic and electrical forces' },
            { id: 'b', text: 'Gravitational force and tension force' },
            { id: 'c', text: 'Frictional force only' },
    ...
    {
        id: 'q2',
        question: 'Which forces act on a box being pushed up an inclined plane?',
        image: 'assets/img/chapter 7/7.png',
        options: [
            { id: 'a', text: 'Applied force, gravitational force, normal force, and frictional force' },
            { id: 'b', text: 'Magnetic force only' },
            { id: 'c', text: 'Electrical force and tension force' },
            { id: 'd', text: 'Buoyant force only' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q3',
        question: 'Which forces act on a stone hung using a spring balance and submerged in liquid?',
        image: 'assets/img/chapter 7/8.png',
        options: [
            { id: 'a', text: 'Magnetic and frictional forces' },
            { id: 'b', text: 'Applied force only' },
            { id: 'c', text: 'Gravitational force, buoyant force, and tension force' },
