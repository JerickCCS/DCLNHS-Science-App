...
export default {
    ...
    setup() {
        ...
        const lessonId = lesson ? String(lesson.id) : "52"
    ...
    <div>
      ...
      <div class="header">
        <div class="title">Technologies for Natural Disasters</div>
      </div>
      <p>According to the World Risk Index (2023), the Philippines is the most at-risk country in the world because of its vulnerability to various hazards such as typhoons, earthquakes, and other natural disasters. Based on the 27 indicators linked to the exposure to natural disasters and societal impact to respond, the Philippines scored 46.82 (0 - low risk; 100 - high risk), which is the highest in all 193 UN countries.</p>
      <p>Earthquakes pose a significant threat to vulnerable areas such as tall structures and buildings. Factors such as site assessment, foundation design, load analysis, structural systems, wind and seismic design, and material selection all influence structure stability.</p>
    </div>
    `,
            `
    <div>
    ...
    <div>
      ...
      <p>According to the Philippine Institute of Volcanology and Seismology (PHIVOLCS), there are more than 3000 structures built along the West Valley Fault. Using a web mapping platform, such as Google Maps, survey the number of tall buildings or structures vulnerable to greater damage if the "Big One" occurs along this fault system. Present your data using infographics.</p>
    </div>
    `
        ])
