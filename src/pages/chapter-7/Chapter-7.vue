...
export default {
    ...
    setup() {
        ...
        const lessons = reactive([
            { id: 50, unitId: 3, chapterId: 7, title: "Lesson 1: Force and Interaction", description: "Learn how forces result from interactions between objects and affect motion", route: "unit-3-chapter-7-lesson-1", type: "lesson", completed: false, current: true, locked: false },
            { id: 51, unitId: 3, chapterId: 7, title: "Lesson 2: Net Force", description: "Understand how multiple forces combine to produce a net force on an object", route: "unit-3-chapter-7-lesson-2", type: "lesson", completed: false, current: false, locked: true },
            { id: 52, unitId: 3, chapterId: 7, title: "Technology in Focus", description: "Explore tools and technologies used to measure and analyze forces", route: "chapter-7-technology", type: "special", completed: false, current: false, locked: true },
            { id: 53, unitId: 3, chapterId: 7, title: "Chapter Review", description: "Review key concepts about force, interaction, and net force", route: "chapter-7-review", type: "review", completed: false, current: false, locked: true },
            { id: 54, unitId: 3, chapterId: 7, title: "Activity 11: Measuring Forces", description: "Measure and compare forces using simple tools and experiments", route: "chapter-7-activity-11", type: "activity", completed: false, current: false, locked: true },
            { id: 55, unitId: 3, chapterId: 7, title: "Chapter Test", description: "Assess your understanding of forces, interactions, and net force", route: "chapter-7-test", type: "test", completed: false, current: false, locked: true }
        ])
