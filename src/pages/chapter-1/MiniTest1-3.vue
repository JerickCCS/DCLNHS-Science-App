                ...
                <div v-if="currentQuestionIndex === 0" class="instructions-card q-mb-lg cartoon-card">
                    <div class="instructions-header">
                        ...
                        <div class="instruction-text">
                            ...
                            <p>1. You test the old batteries in other flashlights.</p>
                            <p>2. You think that the batteries might be worn out.</p>
                            <p>3. You need your flashlight, but it does not turn on.</p>
                            <p>4. Your flashlight finally turns on after replacing the batteries.</p>
                            <p>5. You test your flashlight after replacing the old batteries with new ones.</p>
                            <br>
                            Select the correct answer for each question about the order of these events.
...
const questions = ref([
    {
        id: 'q1',
        question: 'What do you think is the FIRST thing that happened in this situation?',
        options: [
            { id: 'a', text: 'You need your flashlight, but it does not turn on.' },
            { id: 'b', text: 'You test the old batteries in other flashlights.' },
            { id: 'c', text: 'You think that the batteries might be worn out.' },
            { id: 'd', text: 'Your flashlight finally turns on after replacing the batteries.' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q2',
        question: 'What is the SECOND thing that happened?',
        options: [
            { id: 'a', text: 'You think that the batteries might be worn out.' },
            { id: 'b', text: 'You test the old batteries in other flashlights.' },
            { id: 'c', text: 'You test your flashlight after replacing the old batteries with new ones.' },
            { id: 'd', text: 'Your flashlight finally turns on after replacing the batteries.' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q3',
        question: 'What is the THIRD thing that happened?',
        options: [
            { id: 'a', text: 'You test the old batteries in other flashlights.' },
            { id: 'b', text: 'You test your flashlight after replacing the old batteries with new ones.' },
            { id: 'c', text: 'Your flashlight finally turns on after replacing the batteries.' },
            { id: 'd', text: 'You need your flashlight, but it does not turn on.' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q4',
        question: 'What is the FOURTH thing that happened?',
        options: [
            { id: 'a', text: 'You test your flashlight after replacing the old batteries with new ones.' },
            { id: 'b', text: 'Your flashlight finally turns on after replacing the batteries.' },
            { id: 'c', text: 'You think that the batteries might be worn out.' },
            { id: 'd', text: 'You need your flashlight, but it does not turn on.' }
        ],
        correctAnswer: 'a'
    ...
    {
        id: 'q5',
        question: 'What is the FIFTH thing that happened?',
        options: [
            { id: 'a', text: 'Your flashlight finally turns on after replacing the batteries.' },
            { id: 'b', text: 'You test your flashlight after replacing the old batteries with new ones.' },
            { id: 'c', text: 'You think that the batteries might be worn out.' },
            { id: 'd', text: 'You test the old batteries in other flashlights.' }
        ],
        correctAnswer: 'a'
    }
])
