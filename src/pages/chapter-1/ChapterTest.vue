...
export default {
    data() {
        const quizQuestions = [
            {
                question: "Which of the following is correct about scientific models?",
                options: [
                    "Scientific models are used to hide experimental results.",
                    "Mathematical equations and computer simulations are forms of scientific models.",
                    "Scientific models are rigid frameworks and cannot be modified or refined as new data emerge.",
            ...
            },
            {
                ...
                options: [
                    ...
                    "Do trial-and-error computation.",
                    "Express measurements in SI units.",
                    "Express measurements in English system units."
                ],
                correctAnswer: "Use dimensional analysis.",
                image: null // Optional image field added
            },
            {
                question: "Why is it important to use standard units for measurements?",
                options: [
                    "To confuse others.",
                    "To add complexity to the results.",
                    "To make the measurements longer.",
                    "To ensure consistency and allow for accurate comparisons."
                ],
                correctAnswer: "To ensure consistency and allow for accurate comparisons.",
                image: null // Optional image field added
            },
            {
                question: "A package weighs 7500 grams. What is the most appropriate unit to use for its mass, and what is the equivalent measurement in that unit?",
                options: [
                    "decigrams, 75,000 dg",
                    "kilograms, 7.5 kg",
                    "micrograms, 7,500,000,000 µg",
                    "milligrams, 7,500,000 mg"
                ],
                correctAnswer: "kilograms, 7.5 kg",
                image: null // Optional image field added
            },
            {
                question: "You are asked to measure 1 mL of water. Which glassware is best for this measurement, and what is the equivalent value when converted to liters?",
                options: [
                    "beaker, 0.001 L",
                    "graduated cylinder, 0.01 L",
                    "pipette, 0.001 L",
                    "volumetric flask, 0.0001 L"
                ],
                correctAnswer: "pipette, 0.001 L",
                image: null // Optional image field added
            },
            {
                question: "Which of the following best describes a beaker?",
                options: [
                    "An instrument for measuring mass.",
                    "A container for holding or pouring liquids.",
                    "A glassware for measuring an exact amount of liquid.",
                    "A tool for measuring liquids with a high degree of accuracy."
                ],
                correctAnswer: "A container for holding or pouring liquids.",
                image: null // Optional image field added
            },
            {
                question: "What type of balance provides high precision and sensitivity?",
                options: [
                    "Analytical balance.",
                    "Double beam balance.",
                    "Top-loading balance.",
                ...
                correctAnswer: "Analytical balance.",
                image: null // Optional image field added
            },
            {
                question: "Arrange the following steps in using the pipette correctly.",
                options: [
                    "a → b → c",
                    "a → c → b",
                    "b → a → c",
            ...
            {
                question: "Which set is not regarded as science process skills as discussed in this book?",
                options: [
                    "Measuring, predicting, communicating.",
                    "Observing, inferring, classifying.",
                    "Predicting, inferring, measuring.",
                    "Questioning, eliminating, guessing."
                ],
                correctAnswer: "Questioning, eliminating, guessing.",
                image: null // Optional image field added
            },
            {
                question: "Which of the following is not an example of an observation?",
                options: [
                    "The flower is red.",
                    "The flower smells good.",
                    "The stem of a rose has thorns.",
                    "The rose died because the soil was not fertile."
                ],
                correctAnswer: "The rose died because the soil was not fertile.",
                image: null // Optional image field added
            },
            {
                question: "What is the most logical sequence of steps in the scientific method?",
                options: [
                    "Define problem → Experiment → Conclude → Hypothesize.",
                    "Conclude → Define problem → Hypothesize → Gather data → Experiment.",
                    "Define problem → Hypothesize → Experiment → Gather data → Conclude.",
                    "Gather data → Hypothesize → Define problem → Conclude → Experiment."
                ],
                correctAnswer: "Define problem → Hypothesize → Experiment → Gather data → Conclude.",
                image: null // Optional image field added
            },
            {
                question: "A scientist heats a liquid to its boiling point. He measures and records the temperature of the liquid every five minutes. Which of the following steps of the scientific method is he doing?",
                options: [
                ...
                correctAnswer: "Gathering data.",
                image: null // Optional image field added
            },
            {
                question: "What is the process of obtaining information using the senses, such as listening to the sound of an engine?",
                options: [
            ...
            {
                question: "Which best describes the conclusion of an investigation?",
                options: [
                    "Always confirms the hypothesis.",
                    "Derived from experimental data.",
                    "Formulated during experimentation.",
                    "May not be related to the problem and hypothesis."
                ],
                correctAnswer: "Derived from experimental data.",
                image: null // Optional image field added
            },
            {
                question: "Which phrase describes a fair test?",
                options: [
                    "When only one variable is changed.",
                    "When the dependent variables are changed one at a time.",
                    "When the independent variables are changed one at a time.",
                    "When variables are categorized into independent and dependent variables."
                ],
                correctAnswer: "When the independent variables are changed one at a time.",
                image: null // Optional image field added
            }
        ];
    ...
    methods: {
        ...
        finishQuiz() {
            ...
            const chapterNumber = 1; // Chapter 1 test
            ...
            const lessonId = 8; // Lesson ID for this quiz
