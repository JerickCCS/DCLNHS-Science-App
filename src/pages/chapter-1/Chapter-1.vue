...
export default {
    ...
    setup() {
        ...
        const lessons = reactive([
            { id: 1, title: "Lesson 1: Scientific Models", description: "Learn about scientific models", route: "unit-1-chapter-1-lesson-1", completed: false, current: true, locked: false },
            { id: 2, title: "Lesson 2: Measurements and Data Organization", description: "Understanding measurements and organizing data", route: "unit-1-chapter-1-lesson-2", completed: false, current: false, locked: true },
            { id: 3, title: "Lesson 3: Common Laboratory Tools", description: "Introduction to basic laboratory tools and equipment", route: "unit-1-chapter-1-lesson-3", completed: false, current: false, locked: true },
            { id: 4, title: "Lesson 4: Doing Scientific Investigations", description: "Step-by-step guide to performing investigations", route: "unit-1-chapter-1-lesson-4", completed: false, current: false, locked: true },
            { id: 5, title: "Technology in Focus", description: "Explore technology applications in scientific studies", route: "chapter-1-technology", completed: false, current: false, locked: true },
            { id: 6, title: "Chapter Review", description: "Review key concepts", route: "chapter-1-review", completed: false, current: false, locked: true },
            { id: 7, title: "Activity 1: Measurement", description: "Practical activity to measure quantities", route: "chapter-1-activity", completed: false, current: false, locked: true },
            { id: 8, title: "Chapter Test", description: "Assess understanding", route: "chapter-1-test", completed: false, current: false, locked: true }
        ])
