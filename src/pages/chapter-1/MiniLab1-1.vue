...
const questions = ref([
    {
        id: 'q1',
        question: 'What is the most appropriate measuring tool to use for measuring plant height over 7 days?',
        options: [
            { id: 'a', text: 'Thermometer' },
            { id: 'b', text: 'Ruler or measuring tape' },
            { id: 'c', text: 'Scale or balance' },
            { id: 'd', text: 'Measuring cup' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q2',
        question: 'When organizing your plant height data, what is the best way to present it to show changes over time?',
        options: [
            { id: 'a', text: 'List of numbers in a notebook' },
            { id: 'b', text: 'Data table with columns for Day and Height' },
            { id: 'c', text: 'Single measurement at the end of 7 days' },
            { id: 'd', text: 'Only take pictures without measurements' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q3',
        question: 'If your graph shows the plant height increasing each day, what can you conclude?',
        options: [
            { id: 'a', text: 'The plant is not growing' },
            { id: 'b', text: 'The plant is dying' },
            { id: 'c', text: 'The plant is growing over time' },
            { id: 'd', text: 'The measurements are wrong' }
        ],
        correctAnswer: 'c'
    }
])
