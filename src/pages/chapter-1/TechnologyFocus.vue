...
export default {
    ...
    setup() {
        ...
        const lessonId = lesson ? String(lesson.id) : "5"
    ...
    <div>
      ...
      <div class="header">
        <div>
          ...
          <div class="subtitle">Temperature sensors and their types</div>
        </div>
      </div>
      ...
      <p>Considering the long-distance range at which noncontact sensors work, they are widely used in many fields, including healthcare and meteorology. They can be used as non-invasive diagnostic tools and in monitoring environmental conditions. These applications can further advance our scientific capabilities to answer societal problems.</p>
    </div>
    `
