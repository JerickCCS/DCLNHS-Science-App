...
const questions = ref([
    {
        id: 'q1',
        question: 'After being in the refrigerator, Bottle B (cold) will have:',
        options: [
            { id: 'a', text: 'More bubbles and fizz than Bottle A (room temperature)' },
            { id: 'b', text: 'Fewer bubbles and less fizz than Bottle A' },
            { id: 'c', text: 'The same amount of bubbles as Bottle A' },
            { id: 'd', text: 'No bubbles at all' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q2',
        question: 'Which bottle will make a louder "PSHHH!" sound when you open it?',
        options: [
            { id: 'a', text: 'Bottle A (room temperature)' },
            { id: 'b', text: 'Bottle B (cold from refrigerator)' },
            { id: 'c', text: 'Both will sound the same' },
            { id: 'd', text: 'Neither will make a sound' }
        ],
        correctAnswer: 'a'
    }
])
