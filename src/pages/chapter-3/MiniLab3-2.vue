...
const questions = ref([
    {
        id: 'q1',
        question: 'When you add 2 spoons of salt to cold water and stir, what are you most likely to see?',
        options: [
            { id: 'a', text: 'All the salt dissolves immediately' },
            { id: 'b', text: 'Some salt stays undissolved at the bottom' },
            { id: 'c', text: 'The water turns a different color' },
            { id: 'd', text: 'The salt floats on top' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q2',
        question: 'What happens when you do the same with hot water compared to cold water?',
        options: [
            { id: 'a', text: 'Less salt dissolves in hot water' },
            { id: 'b', text: 'About the same amount dissolves' },
            { id: 'c', text: 'More salt dissolves in hot water' },
            { id: 'd', text: 'No salt dissolves at all' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q3',
        question: 'If you see salt at the bottom of the cold water glass, the solution is:',
        options: [
            { id: 'a', text: 'Unsaturated (could dissolve more)' },
            { id: 'b', text: 'Saturated (cannot dissolve more at that temperature)' },
    ...
    {
        id: 'q4',
        question: 'The cold water is saturated with salt. Is it also a concentrated solution?',
        options: [
            { id: 'a', text: 'Yes, because it\'s saturated' },
            { id: 'b', text: 'No, because only a little salt dissolved before it became saturated' },
            { id: 'c', text: 'Yes, because all solutions are concentrated' },
            { id: 'd', text: 'No, because cold water cannot make concentrated solutions' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q5',
        question: 'From this experiment, what have you learned about "saturated" versus "concentrated"?',
        options: [
            { id: 'a', text: 'They mean exactly the same thing' },
            { id: 'b', text: '"Saturated" means no more will dissolve, "concentrated" means a lot is dissolved' },
            { id: 'c', text: 'Only hot solutions can be both saturated and concentrated' },
            { id: 'd', text: 'Only cold solutions can be saturated' }
        ],
        correctAnswer: 'b'
    }
])
