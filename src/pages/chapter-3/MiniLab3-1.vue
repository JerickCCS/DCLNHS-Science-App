...
const questions = ref([
    {
        id: 'q1',
        question: 'In this experiment, you add salt to water, oil, and alcohol. Which one will probably dissolve the MOST salt?',
        options: [
            { id: 'a', text: 'Water' },
            { id: 'b', text: 'Oil' },
            { id: 'c', text: 'Alcohol' }
    ...
    {
        id: 'q2',
        question: 'After stirring, you see salt settled at the bottom of the oil container. This means:',
        options: [
            { id: 'a', text: 'The oil is saturated with salt' },
            { id: 'b', text: 'The oil is concentrated with salt' },
            { id: 'c', text: 'The oil dissolved all the salt' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q3',
        question: 'In the water container, all 1.5g of salt dissolves completely. If you add MORE salt and it also dissolves, then the water was:',
        options: [
            { id: 'a', text: 'Saturated (full)' },
            { id: 'b', text: 'Concentrated (strong)' },
            { id: 'c', text: 'Unsaturated (could take more)' }
        ],
        correctAnswer: 'c'
    },
    {
        id: 'q4',
        question: 'Imagine you keep adding salt to water until no more will dissolve (saturated). You do the same with alcohol. Which statement is TRUE?',
        options: [
            { id: 'a', text: 'Both will be equally salty when saturated' },
            { id: 'b', text: 'Water will be more concentrated (saltier) when saturated than alcohol' },
            { id: 'c', text: 'Alcohol will be more concentrated (saltier) when saturated than water' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q5',
        question: 'The oil with salt at the bottom is saturated. Is it also concentrated with salt?',
        options: [
            { id: 'a', text: 'YES - Saturated always means concentrated' },
            { id: 'b', text: 'NO - Very little salt dissolved in oil, so it\'s not concentrated' },
            { id: 'c', text: 'MAYBE - It depends on the temperature' }
        ],
        correctAnswer: 'b'
    },
    {
        id: 'q6',
        question: 'What does this experiment teach us about "saturated" vs "concentrated"?',
        options: [
            { id: 'a', text: 'They mean exactly the same thing' },
            { id: 'b', text: '"Saturated" means "no more dissolves" but "concentrated" means "a lot dissolved"' },
            { id: 'c', text: 'Only water can make concentrated solutions' }
        ],
        correctAnswer: 'b'
    }
])
