...
export default {
    ...
    setup() {
        ...
        const lessons = reactive([
            // Chapter 3 lessons
            { id: 16, unitId: 1, chapterId: 3, title: "Lesson 1: The Nature of Solutions", description: "Learn about the nature of solutions", route: "unit-1-chapter-3-lesson-1", type: "lesson", completed: false, current: true, locked: false },
            { id: 17, unitId: 1, chapterId: 3, title: "Lesson 2: Solubility and Saturation", description: "Understand solubility and saturation in solutions", route: "unit-1-chapter-3-lesson-2", type: "lesson", completed: false, current: false, locked: true },
            { id: 18, unitId: 1, chapterId: 3, title: "Lesson 3: Factors That Affect Solubility", description: "Explore factors that influence solubility", route: "unit-1-chapter-3-lesson-3", type: "lesson", completed: false, current: false, locked: true },
            { id: 19, unitId: 1, chapterId: 3, title: "Lesson 4: Expressing Concentration of Solutions", description: "Learn how to express solution concentration", route: "unit-1-chapter-3-lesson-4", type: "lesson", completed: false, current: false, locked: true },
            { id: 20, unitId: 1, chapterId: 3, title: "Lesson 5: Practical Examples of Solutions: Acids, Bases, and Salt Solutions", description: "See practical examples of solutions in acids, bases, and salts", route: "unit-1-chapter-3-lesson-5", type: "lesson", completed: false, current: false, locked: true },
            { id: 21, unitId: 1, chapterId: 3, title: "Technology in Focus", description: "Explore technology related to solutions", route: "chapter-3-technology", type: "special", completed: false, current: false, locked: true },
            { id: 22, unitId: 1, chapterId: 3, title: "Chapter Review", description: "Review key concepts of the chapter", route: "chapter-3-review", type: "review", completed: false, current: false, locked: true },
            { id: 23, unitId: 1, chapterId: 3, title: "Activity 3: Some Factors Affecting Solubility", description: "Hands-on activity exploring factors affecting solubility", route: "chapter-3-activity-3", type: "activity", completed: false, current: false, locked: true },
            { id: 24, unitId: 1, chapterId: 3, title: "Activity 4: Percent by Mass of Salt in Aqueous Solutions", description: "Calculate percent by mass of salt in solutions", route: "chapter-3-activity-4", type: "activity", completed: false, current: false, locked: true },
