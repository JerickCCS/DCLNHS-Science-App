...
const questions = ref([
    {
        id: 'q1',
        question: 'Which drink has MORE sugar dissolved in it?',
        options: [
            { id: 'a', text: 'A very sweet lemonade' },
            { id: 'b', text: 'A weak, watery lemonade' }
        ],
        correctAnswer: 'a',
        explanation: 'The sweet lemonade has more sugar dissolved - we call this "concentrated"!'
    },
    {
        id: 'q2',
        question: 'You keep adding sugar to tea and stirring. When no more sugar will dissolve, the tea is:',
        options: [
            { id: 'a', text: 'Saturated (full of sugar)' },
            { id: 'b', text: 'Concentrated (very sweet)' },
            { id: 'c', text: 'Both A and B' }
        ],
        correctAnswer: 'c',
        explanation: 'Good thinking! When no more sugar dissolves (saturated), AND it has lots of sugar (concentrated), it\'s both!'
    },
    {
        id: 'q3',
        question: 'Now think about sand in water. You stir and stir, but only a tiny bit dissolves. When no more dissolves, is it:',
        options: [
            { id: 'a', text: 'Saturated AND concentrated (like the sugary tea)' },
            { id: 'b', text: 'Saturated but NOT concentrated (very watery)' }
        ],
        correctAnswer: 'b',
        explanation: 'Right! Sand water is saturated (no more dissolves) but NOT concentrated (only a tiny bit dissolved).'
    },
    {
        id: 'q4',
        question: 'So... is a saturated solution always a concentrated solution?',
        options: [
            { id: 'a', text: 'YES - Saturated always means lots of stuff dissolved' },
            { id: 'b', text: 'NO - Saturated just means "no more will dissolve," even if only a little dissolved' }
        ],
        correctAnswer: 'b',
        explanation: 'Exactly! "Saturated" = "no more will dissolve." "Concentrated" = "lots dissolved." They\'re different!'
    },
    {
        id: 'q5',
        question: 'Which is an example of "saturated but NOT concentrated"?',
        options: [
            { id: 'a', text: 'A super sweet syrup that can\'t dissolve more sugar' },
            { id: 'b', text: 'Muddy water that can\'t dissolve more mud (but is mostly water)' }
        ],
        correctAnswer: 'b',
        explanation: 'Muddy water is saturated (no more mud dissolves) but not concentrated (very little mud actually dissolved)!'
    }
])
