    ...
    <q-layout view="hHh lpR fFf">
        <q-header class="bg-white text-black">
            <q-toolbar>
                ...
                <q-toolbar-title class="navbar-title">Technology Focus</q-toolbar-title>
...
export default {
    ...
    setup() {
        ...
        const lessonId = lesson ? String(lesson.id) : "21"
...
<div class="header">
        <div class="title">TECHNOLOGY IN FOCUS</div>
      </div>
      <p>Batteries in Modern Devices</p>
      <p>The electrical conductivity of some solutions makes batteries work as portable sources of electrical power.</p>
      <p>Several types of battery power different gadgets and devices. The most commonly used in smartphones and laptops are lithium-ion (Li-ion) batteries, which contain a nonaqueous lithium salt solution. These batteries are also the best option for electric cars, however, they are highly flammable.</p>
    </div>
    `,
            `
    <div>
    ...
    <div>
      ...
      <p>Scientists from the Catholic University of Leuven, Belgium, in collaboration with a renowned car company, have discovered a new material called LiTi₂(PS₄)₃, or LTPS, which could make solid-state batteries possible. How will this material work, and what are other options for solid-state batteries? What do you think would be the greatest drawback of this technology? Form a group with three members, research, and make a simple presentation about this topic.</p>
    </div>
    `
        ])
