...
const questions = ref([
    {
        id: 'q1',
        question: 'Give an example of a solid-in-liquid solution. In your example, what is the solute and what is the solvent?',
        options: [
            { id: 'a', text: 'Example: Salt water. Solute: Salt (dissolves). Solvent: Water (does the dissolving).' },
            { id: 'b', text: 'Example: Soda. Solute: Sugar. Solvent: Air.' },
            { id: 'c', text: 'Example: Smoke. Solute: Air. Solvent: Dust.' },
            { id: 'd', text: 'Example: Vinegar. Solute: Water. Solvent: Oil.' }
        ],
        correctAnswer: 'a'
    },
    {
        id: 'q2',
        question: 'Give an example of a gas-in-liquid solution. What is the solute and solvent?',
        options: [
            { id: 'a', text: 'Example: Salt water. Solute: Water. Solvent: Salt.' },
            { id: 'b', text: 'Example: Sugar water. Solute: Sugar. Solvent: CO₂.' },
            { id: 'c', text: 'Example: Air. Solute: Oxygen. Solvent: Nitrogen.' },
            { id: 'd', text: 'Example: Carbonated drink. Solute: CO₂ gas. Solvent: Water.' }
        ],
        correctAnswer: 'd'
    },
    {
        id: 'q3',
        question: 'Give an example of a liquid-in-liquid solution. What is the solute and solvent?',
        options: [
            { id: 'a', text: 'Example: Soda. Solute: CO₂. Solvent: Water.' },
            { id: 'b', text: 'Example: Bronze. Solute: Tin. Solvent: Copper.' },
            { id: 'c', text: 'Example: Vinegar. Solute: Acetic acid. Solvent: Water.' },
            { id: 'd', text: 'Example: Salt water. Solute: Water. Solvent: Salt.' }
        ],
        correctAnswer: 'c'
    }
])
